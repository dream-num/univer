...
// in this size.
const MAX_UNIVER_MEMORY_OVERFLOW = 5_300_000; // TODO@wzhudev: temporarily added 300KB
...
test('memory', async ({ page }) => {
    ...
    await page.waitForTimeout(2000);
    const memoryAfterSecondInstance = (await getMetrics(page)).JSHeapUsedSize;
    expect(memoryAfterSecondInstance - memoryAfterFirstInstance)
