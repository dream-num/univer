...
test('diff formula related', async () => {
    ...
    await expect(screenshot1).toMatchSnapshot(filename1, { maxDiffPixels: 100 });
    ...
    await expect(screenshot2).toMatchSnapshot(filename2, { maxDiffPixels: 100 });
    ...
    await expect(screenshot3).toMatchSnapshot(filename3, { maxDiffPixels: 100 });
