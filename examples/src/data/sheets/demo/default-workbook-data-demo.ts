...
export const DEFAULT_WORKBOOK_DATA_DEMO: IWorkbookData = {
    ...
    resources: [
        ...
        },
        {
            ...
            data: '{"QeyQwAzexrznf06eqhp-X":[{"uid":"UADk7t","type":"custom","formula1":"=WEEKDAY(A1,2)<6\\r","ranges":[{"startColumn":1,"startRow":0,"endColumn":1,"endRow":6}]}]}',
        },
        {
            name: 'SHEET_AuthzIoMockService_PLUGIN',
            data: '{}',
    ...
    __env__: {
        gitHash: '32eaba3',
        gitBranch: 'fix/data-validation-offset',
        buildTime: '2024-08-16T07:35:28.497Z',
    },
};
