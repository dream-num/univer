                    ...
                    {allSheets.map((sheet) => {
                        ...
                        return (
                            <div
                                ...
                                className={`
                                  univer-relative univer-min-w-0 univer-flex-shrink-0 univer-cursor-pointer
                                  univer-whitespace-nowrap univer-rounded-lg univer-px-4 univer-py-2 univer-text-sm
                                  univer-font-medium univer-transition-all univer-duration-200
                                  ${isActive
                                ? `
