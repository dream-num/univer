...
import { BooleanNumber, ColumnSeparatorType, DocumentFlavor, PageOrientType, SectionType } from '@univerjs/core';
        ...
        sectionBreaks: [
            {
                ...
                pageSize: {
                    width: ptToPixel(495),
                    height: ptToPixel(642),
                },
                sectionType: SectionType.NEXT_PAGE,
                pageOrient: PageOrientType.PORTRAIT,
                marginTop: ptToPixel(20),
                marginBottom: ptToPixel(20),
                marginRight: ptToPixel(20),
                marginLeft: ptToPixel(20),
            },
            {
                startIndex: 3066,
                columnProperties: [
