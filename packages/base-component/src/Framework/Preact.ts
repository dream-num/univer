...
import { ForwardedRef, ForwardFn, forwardRef, PureComponent as PreactPureComponent } from 'preact/compat';
...
export type { ComponentChildren, ComponentClass, ForwardFn, JSX, RefObject, VNode, PreactContext, ForwardedRef };
