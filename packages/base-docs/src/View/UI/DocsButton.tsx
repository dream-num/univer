...
// Types for state
interface IState {
    docs: IToolBarItemProps;
}

export class DocsButton extends Component<IProps, IState> {
    ...
    render(props: IProps, state: IState) {
        ...
        return <Select tooltip={docs.tooltip} tooltipRight={docs.tooltipRight} border={docs.border} needChange={docs.needChange} key={docs.locale} children={docs.children as BaseSelectProps[]} label={docs.label} icon={docs.icon} />;
    }
}
