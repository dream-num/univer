...
describe('test cases in clipboard', () => {
    ...
    beforeEach(() => {
        ...
        commandService.registerCommand(InnerCutContentCommand);
    ...
    describe('Test cut in multiple ranges', () => {
        it('Should cut content to each selection ranges', async () => {
            ...
            await commandService.executeCommand(InnerCutContentCommand.id, commandParams);
