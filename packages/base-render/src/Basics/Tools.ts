import { BaselineOffset, FontStyleType, IScale, ISelectionCellWithCoord, ISelectionRange, ISelectionRangeWithCoord, IStyleBase, Nullable, Tools } from '@univerjs/core';
...
export const generateRandomKey = (prefix: string = 'obj', keyLength: number = GENERATE_RANDOM_KEY_DEFAULT_LENGTH): string => {
...
export function mergeInfoOffset(mergeInfo: ISelectionRangeWithCoord, offsetX: number, offsetY: number, scaleX: number, scaleY: number) {
