...
import { LineType } from '../../Base/IDocumentSkeletonCached';
...
import './Extensions';
import { calculateRectRotate, getRotateOffsetAndFarthestHypotenuse } from '../../Base/Draw';
import { fixLineWidthByScale, getScale, degToRad } from '../../Base/Tools';
