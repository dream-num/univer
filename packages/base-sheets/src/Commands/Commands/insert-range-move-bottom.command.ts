...
export interface IInsertRangeMoveBottomParams {
    workbookId?: string;
    worksheetId?: string;
    range?: IRangeData;
 ...
 */
export const InsertRangeMoveBottomCommand: ICommand = {
    type: CommandType.COMMAND,
    id: 'sheet.command.insert-range-move-bottom',

    handler: async (accessor: IAccessor, params: IInsertRangeMoveBottomParams) => {
