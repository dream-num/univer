import { CommandType, IMutation, ICurrentUniverService, ObjectMatrix, Tools, Nullable, IRangeData, ObjectMatrixPrimitiveType, ICellV, ICellData } from '@univerjs/core';
 ...
 */
export const SetRangeFormattedValueUndoMutationFactory = (accessor: IAccessor, params: ISetRangeFormattedValueMutationParams): ISetRangeFormattedValueMutationParams => {
