...
import { IToolBarItemProps, ToolBarModel1 } from '../Model/ToolBarModal1';
 ...
 *
 */
export class ToolBarController1 {
    private _toolBarModel: ToolBarModel1;

    private _plugin: SpreadsheetPlugin;

    private _toolBarComponent: ToolBar1;
    ...
    constructor(plugin: SpreadsheetPlugin) {
        ...
        this._toolBarModel = new ToolBarModel1();
    ...
    init() {
        ...
        this._plugin.getObserver('onToolBar1DidMountObservable')?.add((component) => {
            //初始化视图
    ...
    initRegisterComponent() {
        ...
        // 注册自定义组件
        this._plugin.registerComponent('LineColor', LineColor);
        this._plugin.registerComponent('LineColorPicker', ColorPicker, { onClick: (color: string, e: MouseEvent) => this.handleLineColor(color, e) });
