...
export interface BaseSlideContainerProps {
    config: BaseSlideContainerConfig;
}
 ...
 */
export class SlideContainer extends Component<BaseSlideContainerProps, IState> {
    ...
    componentDidMount() {
        ...
        this.setState(
            ...
            () => {
                ...
                this.getContext()
                    .getPluginManager()
                    .getRequirePluginByName<SlidePlugin>(PLUGIN_NAMES.SLIDE)
                    .getObserver('onSlideContainerDidMountObservable')
