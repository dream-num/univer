...
export const BackIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} className={props.className} name="foward" style={props.style}>
        <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5692" width="1em" height="1em" fill="currentColor">
            <path
...
export const FormatIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} name="foward" style={props.style}>
        <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5955" width="1em" height="1em" fill="currentColor">
            <path
...
export const NextIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} className={props.className} name="nextIcon" style={props.style}>
        <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5311" width="1em" height="1em" fill="currentColor">
...
export const CorrectIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} className={props.className} name="foward" style={props.style}>
        <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5311" width="1em" height="1em" fill="currentColor">
            ...
            <path d="M780.928 312.234667l60.373333 60.330666-331.904 331.861334-60.330666-60.330667z" p-id="5313"></path>
        </svg>
    </Icon>
);
...
export const LtIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} className={props.className} name="foward" style={props.style}>
        <svg width="1em" height="1em" fill="currentColor" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1732">
            <path d="M224.45 538.68l575.11-346.21-0.05-68.75-575.03 345.61-0.03 69.35z" p-id="1733"></path>
            <path d="M224.45 538.68l575.08 356.96v-69.52L224.48 469.33l-0.03 69.35z" p-id="1734"></path>
        </svg>
    </Icon>
);
...
export const CloseIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} className={props.className} name="foward" style={props.style}>
        <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5318" width="1em" height="1em" fill="currentColor">
            <path d="M330.965333 270.634667l422.4 422.4-60.330666 60.330666-422.4-422.4z" p-id="5319"></path>
            <path d="M753.365333 330.965333l-422.4 422.4-60.330666-60.330666 422.4-422.4z" p-id="5320"></path>
        </svg>
    </Icon>
);
...
export const MenuIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} className={props.className} name="foward" style={props.style}>
        <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5446" width="1em" height="1em" fill="currentColor">
            <path
...
export const HideIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} className={props.className} name="foward" style={props.style}>
        <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6513" width="1em" height="1em" fill="currentColor">
            <path
                ...
                p-id="6514"
            ></path>
            <path d="M818.614857 146.285714l51.712 51.712L197.997714 870.4 146.285714 818.688z" p-id="6515"></path>
            <path
