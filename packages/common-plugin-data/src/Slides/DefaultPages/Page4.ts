...
import { DEFAULT_WORKBOOK_DATA } from '../../Sheets/DEFAULT_WORKBOOK_DATA';

const worksheetConfig = DEFAULT_WORKBOOK_DATA.sheets[DEFAULT_WORKBOOK_DATA.sheetOrder[0]] as IWorksheetConfig;
const spreadStyles = DEFAULT_WORKBOOK_DATA.styles;
