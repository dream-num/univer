...
/**
 * Command injector, after the core triggers the Command, the plug-in receives the Command Observer message, inserts its own Action, and combines it into one Command, which is convenient for undo/redo to be executed as a command.
 *
 * @privateRemarks
