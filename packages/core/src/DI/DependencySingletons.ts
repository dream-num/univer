...
const singletonDependencies: Array<[DependencyIdentifier<any>, DependencyItem<any>]> = [];
...
export function getSingletonDependencies(): Array<[DependencyIdentifier<any>, DependencyItem<any>]> {
    if (singletonFetchedLock) {
        console.warn('[DI]: Singleton dependencies has been fetched before by an other injector. ' + 'Please avoid fetching singleton dependencies twice.');
    }
