...
export interface IMergeParagraphActionData extends IDocActionData {
    text: string;
}

export class MergeParagraphAction extends DocActionBase<
    IMergeParagraphActionData,
    IMergeParagraphActionData
> {
    constructor(
        actionData: IMergeParagraphActionData,
