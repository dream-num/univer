...
export interface ISplitParagraphAction extends IDocActionData {
    text: string;
}

export class SplitParagraphAction extends DocActionBase<
    ISplitParagraphAction,
    ISplitParagraphAction
> {
    constructor(
        actionData: ISplitParagraphAction,
