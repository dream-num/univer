...
export class Range {
    ...
    private _setStyle(
        ...
        const command = new SheetsCommand(_context.getWorkBook(), setStyle);
    ...
    setBorder(...argument: any): Range {
        ...
        const commandCC = new SheetsCommand(_workbook, ...actions);
    ...
    insertCells(...argument: any): Range {
        ...
        const command = new SheetsCommand(_context.getWorkBook(), insertValue);
        _commandManager.invoke(command);
        return this;
    }
    ...
    merge(): Range {
        ...
        const command = new SheetsCommand(_context.getWorkBook(), dataRowInsert);
        _commandManager.invoke(command);
    ...
    removeDuplicates(...argument: any): Range {
        ...
        const command = new SheetsCommand(_context.getWorkBook(), ...removeDatas);
        _commandManager.invoke(command);
        return this;
    }
