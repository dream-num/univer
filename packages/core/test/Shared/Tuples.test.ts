...
test('checkup', () => {
    const test = (...argument: any) => Tuples.checkup(argument, Tuples.BOOLEAN_TYPE, Tuples.STRING_TYPE, Tuples.NUMBER_TYPE, Tuples.FUNCTION_TYPE);
    expect(test(false, '1', 1, () => {})).toEqual(true);
    const test1 = (...argument: any) => Tuples.checkup(argument, Tuples.BOOLEAN_TYPE);
    ...
    const test4 = (...argument: any) => Tuples.checkup(argument, Tuples.FUNCTION_TYPE);
