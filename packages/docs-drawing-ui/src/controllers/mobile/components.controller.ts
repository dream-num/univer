...
import { MobileDocDrawingPanel } from '../../views/doc-image-panel/MobileDocDrawingPanel';
...
export class MobileComponentsController extends Disposable {
    constructor(@Inject(ComponentManager) componentManager: ComponentManager) {
        super();
        this.disposeWithMe(componentManager.register(COMPONENT_DOC_DRAWING_PANEL, MobileDocDrawingPanel));
    }
}
