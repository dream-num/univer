...
export class MobileDocDrawingPopupMenuController extends RxDisposable {
        ...
        const subscriptions = [
            ...
            transformer.createControl$.subscribe(() => {
                ...
                const popup = this._canvasPopManagerService.attachPopupToObject(
                    object,
                    {
                        componentKey: isImage || isChart ? COMPONENT_MOBILE_IMAGE_POPUP_MENU : MOBILE_DOC_ELEMENT_MENU,
