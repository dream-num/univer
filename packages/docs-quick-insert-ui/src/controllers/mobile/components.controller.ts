...
import { MobileQuickInsertPopup } from '../../views/mobile/MobileQuickInsertPopup';
...
export class MobileComponentsController extends Disposable {
    ...
    protected _registerPopup(): void {
        this.disposeWithMe(this._componentManager.register(QuickInsertPopup.componentKey, MobileQuickInsertPopup));
    }
}
