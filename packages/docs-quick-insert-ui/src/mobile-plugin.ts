...
import { UniverDocsQuickInsertUIPlugin } from './plugin';

@DependentOn(UniverDocsPlugin, UniverDocsDrawingPlugin, UniverDocsDrawingMobileUIPlugin, UniverDocsMobileUIPlugin, UniverDrawingPlugin, UniverDrawingMobileUIPlugin, UniverRenderEnginePlugin)
export class UniverDocsQuickInsertMobileUIPlugin extends UniverDocsQuickInsertUIPlugin {
    static override pluginName = UniverDocsQuickInsertUIPlugin.pluginName;
