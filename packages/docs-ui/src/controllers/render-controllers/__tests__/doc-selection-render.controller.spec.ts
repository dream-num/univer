...
function createController(options: { readonly?: boolean; hasEditor?: boolean; preserveHostFocus?: boolean; embedRecentInteraction?: boolean; embedContains?: boolean; mobile?: boolean; editing?: boolean; mobileEditMode?: boolean; focusing?: boolean; activeOffset?: number; nextActiveOffset?: number; documentFlavor?: DocumentFlavor; scale?: number; unitId?: string; currentSelectionUnitId?: string; currentSelection?: Pick<IDocSelectionInnerParam, 'isEditing' | 'rectRanges' | 'textRanges'>; embedRuntimeFocusCoordinator?: EmbedRuntimeFocusCoordinator } = {}) {
