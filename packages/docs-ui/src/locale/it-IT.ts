...
const locale: typeof enUS = {
    'docs-ui': {
        pasteOptions: {
            ...
            useKeyboard: 'Impossibile accedere agli appunti. Usa {0} per incollare, poi cambia il formato con le opzioni di incolla.',
        ...
        mobile: {
            ...
            expand: 'Espandi strumenti',
            collapse: 'Comprimi strumenti',
        },
        layout: {
        ...
        statistics: {
            ...
            currentPageOfTotal: 'Pagina {0} di {1}',
            pages: 'Pagine',
            words: 'Parole',
