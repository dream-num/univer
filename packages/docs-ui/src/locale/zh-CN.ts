...
const locale: typeof enUS = {
    'docs-ui': {
        ...
        toolbar: {
            ...
            sectionBreakNextColumn: '分节符（下一栏）',
            sectionBreakEvenPage: '分节符（偶数页）',
            sectionBreakOddPage: '分节符（奇数页）',
            heading: {
                tooltip: '标题',
                normal: '普通文本',
                leading1: '标题1',
        ...
        statistics: {
            ...
            selection: '当前选区',
            wordCount: '字数 {0}',
            selectedWords: '字数 {0} / {1}',
            currentPage: '第 {0} 页',
            currentPageOfTotal: '第 {0} 页，共 {1} 页',
            pages: '页数',
            words: '字数',
            charactersWithoutSpaces: '字符数（不计空格）',
            charactersWithSpaces: '字符数（计空格）',
            paragraphs: '段落数',
            lines: '行数',
            nonAsianWords: '非亚洲语言字数',
            asianCharactersAndKoreanWords: '亚洲语言字符、韩文单词',
        },
        placeholder: {
            heading1: '标题1',
            heading2: '标题2',
