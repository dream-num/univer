...
describe('docs custom block host adapter', () => {
    ...
    it('creates rich text insert and remove plans from the host document body', () => {
        ...
        const adapter = createDocsCustomBlockHostAdapterContribution(undefined, univerInstanceService as never);
        const context = {
            embedId: 'embed-1',
            hostUnitId: 'doc-1',
            hostType: UniverInstanceType.UNIVER_DOC,
    ...
    it('falls back to stored anchor data for remove plans', () => {
