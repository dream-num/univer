...
export type { DocumentSectionHeaderFooterVariant, IFDocumentSectionColumnOptions, IFDocumentSectionDescription, IFDocumentSectionHeaderFooterOptions } from './f-document-section';
