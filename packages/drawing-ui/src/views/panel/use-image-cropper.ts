...
export function useImageCropper(props: IImageCropperProps) {
    ...
    return { drawingParam, cropperShow, localeService, cropValue, cropOptions, handleCropChange, onCropperBtnClick, ShapeClipPicker };
}
