...
const DEFAULT_SLOT_CLASS = 'univer-box-border univer-absolute univer-inset-0';
...
export function ensureEmbedDefaultRuntimeSlots(root: HTMLElement): IDisposable {
    ...
    ensureSlot(root, EMBED_CONTENT_ROOT_ATTRIBUTE, 'univer-overflow-hidden', created);
    ensureSlot(root, EMBED_CANVAS_ROOT_ATTRIBUTE, 'univer-pointer-events-none univer-overflow-hidden [&>*]:univer-pointer-events-auto', created);
    ensureSlot(root, EMBED_OVERLAY_ROOT_ATTRIBUTE, 'univer-pointer-events-none [&>*]:univer-pointer-events-auto', created);
    ensureSlot(root, EMBED_POPUP_ROOT_ATTRIBUTE, 'univer-pointer-events-none [&>*]:univer-pointer-events-auto', created);
