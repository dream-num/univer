...
import { EMBED_INTERACTION_BOUNDARY_OWNER_ATTRIBUTE, EmbedInteractionBoundaryService, isEventTargetInSameEmbedInteractionBoundary } from './embed-interaction-boundary.service';
