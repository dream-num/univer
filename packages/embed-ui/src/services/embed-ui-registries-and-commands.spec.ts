...
import { EMBED_CANVAS_ROOT_ATTRIBUTE, EMBED_CONTENT_ROOT_ATTRIBUTE, EMBED_FOOTER_SLOT_ATTRIBUTE, EMBED_MENU_SLOT_ATTRIBUTE, EMBED_OVERLAY_ROOT_ATTRIBUTE, EMBED_POPUP_ROOT_ATTRIBUTE, ensureEmbedDefaultRuntimeSlots } from '../common/embed-runtime-slots';
...
describe('embed-ui registries and commands', () => {
    it('manages host adapter contributions and rejects missing create adapters', () => {
        ...
        service.removeAnchor({ embedId: 'embed-1', hostUnitId: 'host-1', hostType: UniverInstanceType.UNIVER_SHEET, entry: 'sheets-sheet-tab', hostAnchorId: 'anchor-1' });
