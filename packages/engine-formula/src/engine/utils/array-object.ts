    ...
    if (valueObject.isArray()) {
        ...
        if (valueRowCount === 1 && valueColumnCount === 1) {
            ...
            for (let r = 0; r < rowCount; r++) {
                const row = [];
                for (let c = 0; c < columnCount; c++) {
                    const v = (valueObject as ArrayValueObject).get(0, c) as BaseValueObject || (defaultValue ?? new NullValueObject(0));
                    row.push(v);
                }
                result.push(row);
            }
            ...
            for (let r = 0; r < rowCount; r++) {
                const row = [];
                for (let c = 0; c < columnCount; c++) {
                    const v = (valueObject as ArrayValueObject).get(r, 0) as BaseValueObject || (defaultValue ?? new NullValueObject(0));
                    row.push(v);
                }
                result.push(row);
            }
            ...
            for (let r = 0; r < rowCount; r++) {
                const row = [];
                for (let c = 0; c < columnCount; c++) {
                    const v = (valueObject as ArrayValueObject).get(r, c) as BaseValueObject || (defaultValue ?? new NullValueObject(0));
                    row.push(v);
                }
                result.push(row);
            }
