...
describe('arrayValueObject round method test', () => {
    ...
    describe('round', () => {
        it('origin nm, param nm', () => {
            ...
            const result = originArrayValueObject.round(roundArrayValueObject);
        ...
        it('origin nm multiple formats, param 1 number', () => {
            ...
            const result = originArrayValueObject.round(roundValueObject);
        ...
        it('origin 1 number, param nm multiple formats', () => {
            ...
            const result = originValueObject.round(roundArrayValueObject);
