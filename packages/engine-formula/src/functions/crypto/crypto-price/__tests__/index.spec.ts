...
import { FUNCTION_NAMES_CRYPTO } from '../../function-names';
import { CryptoPrice } from '../index';

describe('Test abs function', () => {
    const testFunction = new CryptoPrice(FUNCTION_NAMES_CRYPTO.CRYPTO_PRICE);
    ...
    describe('Price', () => {
        ...
        it('Value is array', () => {
            ...
            expect(transformToValue(result.getArrayValue())).toStrictEqual([[1, ErrorType.VALUE, 1.23, 1, 0, 0], [0, 100, 2.34, ErrorType.VALUE, 3, ErrorType.NAME]]);
        });
    });
});
