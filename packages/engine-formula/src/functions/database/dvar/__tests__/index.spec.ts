...
import { Dvar } from '../index';

describe('Test dvar function', () => {
    const testFunction = new Dvar(FUNCTION_NAMES_DATABASE.DVAR);
    ...
    describe('Dvar', () => {
        ...
        it('Database value test', () => {
            ...
            expect(getObjectValue(result2)).toStrictEqual(ErrorType.DIV_BY_ZERO);
            ...
            expect(getObjectValue(result4)).toStrictEqual(ErrorType.DIV_BY_ZERO);
        });
        ...
        it('Criteria value test', () => {
            ...
            const result = testFunction.calculate(database, field, criteria);
            expect(getObjectValue(result)).toStrictEqual(7.1);
            ...
            expect(getObjectValue(result4)).toStrictEqual(7.1);
        });
    });
});
