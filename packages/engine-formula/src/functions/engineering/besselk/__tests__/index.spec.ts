...
import { Besselk } from '../index';

describe('Test besselk function', () => {
    const testFunction = new Besselk(FUNCTION_NAMES_ENGINEERING.BESSELK);
    ...
    describe('Besselk', () => {
        it('Value is normal number', () => {
            ...
            expect(getObjectValue(result, true)).toBe(0.277387803632);
        });
