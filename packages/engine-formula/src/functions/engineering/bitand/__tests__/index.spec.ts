...
import { Bitand } from '../index';
import { BooleanValueObject, NullValueObject, NumberValueObject, StringValueObject } from '../../../../engine/value-object/primitive-object';
import { ArrayValueObject, transformToValue, transformToValueObject } from '../../../../engine/value-object/array-value-object';
import { ErrorType } from '../../../../basics/error-type';
import { ErrorValueObject } from '../../../../engine/value-object/base-value-object';

describe('Test bitand function', () => {
    const testFunction = new Bitand(FUNCTION_NAMES_ENGINEERING.BITAND);

    describe('Bitand', () => {
        it('Value is normal number', () => {
            const number1 = NumberValueObject.create(13);
        ...
        it('Value is number string', () => {
            ...
            const number2 = NumberValueObject.create(5);
            const result = testFunction.calculate(number1, number2);
        ...
        it('Value is array', () => {
            ...
            expect(transformToValue(result.getArrayValue())).toStrictEqual([
                [1, ErrorType.VALUE, ErrorType.NUM, 1, 0, 0],
                [0, 0, ErrorType.NUM, ErrorType.VALUE, ErrorType.NUM, ErrorType.NAME],
            ]);
        });
    });
});
