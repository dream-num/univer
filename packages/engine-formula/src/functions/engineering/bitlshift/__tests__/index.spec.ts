...
import { Bitlshift } from '../index';
import { BooleanValueObject, NullValueObject, NumberValueObject, StringValueObject } from '../../../../engine/value-object/primitive-object';
import { ArrayValueObject, transformToValue, transformToValueObject } from '../../../../engine/value-object/array-value-object';
import { ErrorType } from '../../../../basics/error-type';
import { ErrorValueObject } from '../../../../engine/value-object/base-value-object';

describe('Test bitlshift function', () => {
    const testFunction = new Bitlshift(FUNCTION_NAMES_ENGINEERING.BITLSHIFT);
    ...
    describe('Bitlshift', () => {
        ...
        it('Value is array', () => {
            ...
            expect(transformToValue(result.getArrayValue())).toStrictEqual([
                [4, ErrorType.VALUE, ErrorType.NUM, 4, 0, 0],
                [0, 400, ErrorType.NUM, ErrorType.VALUE, ErrorType.NUM, ErrorType.NAME],
            ]);
        });
    });
});
