...
import { Dec2bin } from '../index';
import { BooleanValueObject, NullValueObject, NumberValueObject, StringValueObject } from '../../../../engine/value-object/primitive-object';
import { ArrayValueObject, transformToValueObject } from '../../../../engine/value-object/array-value-object';
import { ErrorType } from '../../../../basics/error-type';
import { ErrorValueObject } from '../../../../engine/value-object/base-value-object';

describe('Test dec2bin function', () => {
    const testFunction = new Dec2bin(FUNCTION_NAMES_ENGINEERING.DEC2BIN);

    describe('Dec2bin', () => {
        it('Value is normal number', () => {
            const number = NumberValueObject.create(9);
            const places = NumberValueObject.create(4);
            const result = testFunction.calculate(number, places);
            expect(result.getValue()).toBe('1001');
        });
        ...
        it('Number < -512 || > 512 || < 0', () => {
            ...
            expect(result2.getValue()).toBe('1111101010');
        });
