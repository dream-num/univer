...
import { Gestep } from '../index';
import { BooleanValueObject, NullValueObject, NumberValueObject, StringValueObject } from '../../../../engine/value-object/primitive-object';
import { ArrayValueObject, transformToValueObject } from '../../../../engine/value-object/array-value-object';
import { ErrorType } from '../../../../basics/error-type';
import { ErrorValueObject } from '../../../../engine/value-object/base-value-object';

describe('Test gestep function', () => {
    const testFunction = new Gestep(FUNCTION_NAMES_ENGINEERING.GESTEP);

    describe('Gestep', () => {
        it('Value is normal number', () => {
            const number = NumberValueObject.create(5);
            const step = NumberValueObject.create(4);
            const result = testFunction.calculate(number, step);
