...
describe('Test hex2dec function', () => {
    const testFunction = new Hex2dec(FUNCTION_NAMES_ENGINEERING.HEX2DEC);

    describe('Hex2dec', () => {
        it('Value is normal number', () => {
            const number = StringValueObject.create('A5');
