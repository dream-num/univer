...
import { Hex2oct } from '../index';
import { BooleanValueObject, NullValueObject, NumberValueObject, StringValueObject } from '../../../../engine/value-object/primitive-object';
import { ArrayValueObject, transformToValueObject } from '../../../../engine/value-object/array-value-object';
import { ErrorType } from '../../../../basics/error-type';
import { ErrorValueObject } from '../../../../engine/value-object/base-value-object';

describe('Test hex2oct function', () => {
    const testFunction = new Hex2oct(FUNCTION_NAMES_ENGINEERING.HEX2OCT);
    ...
    describe('Hex2oct', () => {
        it('Value is normal number', () => {
            ...
            expect(result.getValue()).toBe('017');
        });

        it('Number < 1098974756864 || > 536870911', () => {
            const number = StringValueObject.create('FFFFF00000');
            const result = testFunction.calculate(number);
            expect(result.getValue()).toBe('7774000000');

            const number2 = StringValueObject.create('FFFFF0000');
