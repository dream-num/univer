...
import { Imsech } from '../index';
import { BooleanValueObject, NumberValueObject, StringValueObject } from '../../../../engine/value-object/primitive-object';
import { ArrayValueObject, transformToValueObject } from '../../../../engine/value-object/array-value-object';
import { ErrorType } from '../../../../basics/error-type';
import { ErrorValueObject } from '../../../../engine/value-object/base-value-object';

describe('Test imsech function', () => {
    const testFunction = new Imsech(FUNCTION_NAMES_ENGINEERING.IMSECH);

    describe('Imsech', () => {
        it('Value is normal number', () => {
            const inumber = StringValueObject.create('5+12i');
            const result = testFunction.calculate(inumber);
            expect(result.getValue()).toBe('0.0113717647601419+0.00723019299882505i');
        });
        ...
        it('Value is number string', () => {
            ...
            const result = testFunction.calculate(inumber);
            expect(result.getValue()).toBe(0.425096034942281);
        });
