...
describe('Test accrintm function', () => {
    ...
    describe('Accrintm', () => {
        ...
        it('checks the serial-zero boundary in both date systems', () => {
            ...
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(10.027397260273972, 12);

            testFunction.setDateSystem(DateSystem.Date1904);
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(10, 12);
