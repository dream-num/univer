...
describe('Test coupdaybs function', () => {
    const testFunction = new Coupdaybs(FUNCTION_NAMES_FINANCIAL.COUPDAYBS);
    ...
    describe('Coupdaybs', () => {
        it('Value is normal', () => {
            ...
            expect(result.getValue()).toStrictEqual(71);
        });
        ...
        it('Basis value test', () => {
            ...
            expect(result2.getValue()).toStrictEqual(70);
