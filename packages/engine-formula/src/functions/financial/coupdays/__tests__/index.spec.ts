...
import { Coupdays } from '../index';

describe('Test coupdays function', () => {
    const testFunction = new Coupdays(FUNCTION_NAMES_FINANCIAL.COUPDAYS);
    ...
    describe('Coupdays', () => {
        it('Value is normal', () => {
            ...
            expect(result.getValue()).toStrictEqual(181);
        });
        ...
        it('uses the configured date system for serial dates', () => {
            ...
            expect(testFunction.calculate(...args).getValue()).toStrictEqual(184);
