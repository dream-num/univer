...
describe('Test coupdaysnc function', () => {
    const testFunction = new Coupdaysnc(FUNCTION_NAMES_FINANCIAL.COUPDAYSNC);
    ...
    describe('Coupdaysnc', () => {
        ...
        it('Value is normal, settlement and maturity test', () => {
            ...
            const settlement2 = StringValueObject.create('2011-11-25');
            const maturity2 = StringValueObject.create('2014-3-15');
            ...
            expect(result2.getValue()).toStrictEqual(111);
        });
        ...
        it('Basis value test', () => {
            ...
            expect(result2.getValue()).toStrictEqual(110);
