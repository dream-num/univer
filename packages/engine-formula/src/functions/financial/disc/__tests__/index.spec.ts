...
describe('Test disc function', () => {
    ...
    describe('Disc', () => {
        ...
        it('checks the serial-zero boundary in both date systems', () => {
            ...
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(0.9962704918032788, 12);

            testFunction.setDateSystem(DateSystem.Date1904);
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(0.999, 12);
