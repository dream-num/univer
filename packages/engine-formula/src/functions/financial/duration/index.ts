...
export class Duration extends BaseFunction {
    ...
    override calculate(
        ...
        const result = calculateDuration(settlementSerialNumber, maturitySerialNumber, couponValue, yldValue, frequencyValue, basisValue, this.getDateSystem());
