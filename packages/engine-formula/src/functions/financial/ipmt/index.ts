...
export class Ipmt extends BaseFunction {
    ...
    override calculate(rate: BaseValueObject, per: BaseValueObject, nper: BaseValueObject, pv: BaseValueObject, fv?: BaseValueObject, type?: BaseValueObject): BaseValueObject {
        ...
        const resultArray = rateArray.map((rateObject, rowIndex, columnIndex) => {
            ...
            const [_rateObject, _perObject, _nperObject, _pvObject, _fvObject, _typeObject] = variants as BaseValueObject[];
