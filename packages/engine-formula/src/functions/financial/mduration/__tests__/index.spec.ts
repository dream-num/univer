...
describe('Test mduration function', () => {
    ...
    describe('Mduration', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result, true)).toBe(10.4489428532);
        });
        ...
        it('Frequency value test', () => {
            ...
            expect(getObjectValue(result2, true)).toBe(9.97970415591);
            ...
            expect(getObjectValue(result3, true)).toBe(10.4730008502);
        });
        ...
        it('Basis value test', () => {
            ...
            expect(getObjectValue(result2, true)).toBe(10.4489428532);
            ...
            expect(getObjectValue(result3, true)).toBe(10.4489428532);
            ...
            expect(getObjectValue(result4, true)).toBe(10.4489428532);
        ...
        it('checks the serial-zero boundary in both date systems', () => {
            ...
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(0.9384500933673366, 12);
