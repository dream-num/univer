...
describe('Test oddfprice function', () => {
    ...
    describe('Oddfprice', () => {
        ...
        it('Frequency value test', () => {
            ...
            expect(getObjectValue(result2, true)).toBe(113.494585545507);
            ...
            expect(getObjectValue(result3, true)).toBe(113.650021611);
        });
        ...
        it('Basis value test', () => {
            ...
            expect(getObjectValue(result2, true)).toBe(113.599205828238);
            ...
            expect(getObjectValue(result3, true)).toBe(113.598799608325);
            ...
            expect(getObjectValue(result4, true)).toBe(113.596112595205);
            ...
            expect(getObjectValue(result5, true)).toBe(113.599205828238);
            ...
            expect(getObjectValue(result6, true)).toBe(113.599205828238);
        });
