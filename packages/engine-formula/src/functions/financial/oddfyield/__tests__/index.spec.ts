...
describe('Test oddfyield function', () => {
    ...
    describe('Oddfyield', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result, true)).toBe(0.100766449804);
        });
        ...
        it('Frequency value test', () => {
            ...
            expect(getObjectValue(result2, true)).toBe(0.101169886094);
            ...
            expect(getObjectValue(result3, true)).toBe(0.100563371156);
        });
        ...
        it('Basis value test', () => {
            ...
            expect(getObjectValue(result2, true)).toBe(0.100765302483);
            ...
            expect(getObjectValue(result3, true)).toBe(0.100764261201);
            ...
            expect(getObjectValue(result4, true)).toBe(0.100769679523);
            ...
            expect(getObjectValue(result5, true)).toBe(0.100765302483);
            ...
            expect(getObjectValue(result6, true)).toBe(0.100765302483);
        });
