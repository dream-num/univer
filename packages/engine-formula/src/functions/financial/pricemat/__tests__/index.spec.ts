...
describe('Test pricemat function', () => {
    ...
    describe('Pricemat', () => {
        ...
        it('uses the configured date system for numeric serial dates', () => {
            ...
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(98.1469135802469, 10);
            testFunction.setDateSystem(DateSystem.Date1904);
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(98.151680729917, 10);
            testFunction.setDateSystem(DateSystem.Date1900);
        });
