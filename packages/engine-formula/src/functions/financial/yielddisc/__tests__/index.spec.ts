...
describe('Test yielddisc function', () => {
    ...
    describe('Yielddisc', () => {
        ...
        it('checks the serial-zero boundary in both date systems', () => {
            ...
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(0.11080752884031576, 12);

            testFunction.setDateSystem(DateSystem.Date1904);
            expect(getObjectValue(testFunction.calculate(...args))).toBeCloseTo(0.11111111111111116, 12);
