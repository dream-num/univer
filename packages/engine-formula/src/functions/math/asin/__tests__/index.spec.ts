...
describe('Test asin function', () => {
    ...
    describe('Asin', () => {
        ...
        it('Value is number string', () => {
            ...
            const result = testFunction.calculate(value);
            expect(getObjectValue(result, true)).toBe(0.523598775598);
        });
        ...
        it('Value is array', () => {
            ...
            expect(getObjectValue(result, true)).toStrictEqual([
                [1.57079632679, '#VALUE!', ErrorType.NUM, 1.57079632679, 0, 0],
                [0, ErrorType.NUM, ErrorType.NUM, '#VALUE!', ErrorType.NUM, '#NAME?'],
            ]);
        });
    });
});
