...
describe('Test asin function', () => {
    const textFunction = new Asin(FUNCTION_NAMES_MATH.ASIN);
    ...
    describe('Asin', () => {
        ...
        it('Value is array', () => {
            ...
            expect(transformToValue(result.getArrayValue())).toStrictEqual([[Math.PI / 2, '#VALUE!', Math.asin(0.5), Math.PI / 2, 0],
                [0, Math.asin(0.5), Math.asin(0.25), '#VALUE!', -Math.PI / 2]]);
        });
    });
});
