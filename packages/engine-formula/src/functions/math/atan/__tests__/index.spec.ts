...
describe('Test atan function', () => {
    const textFunction = new Atan(FUNCTION_NAMES_MATH.ATAN);
    ...
    describe('Atan', () => {
        ...
        it('Value is array', () => {
            ...
            expect(transformToValue(result.getArrayValue())).toStrictEqual([[0.7853981633974483, '#VALUE!', 0.8760580505981934, 0.7853981633974483, '#VALUE!'],
                ['#VALUE!', 0.009999666686665238, 1.1659045405098132, '#VALUE!', -1.2490457723982544]]);
        });
    });
});
