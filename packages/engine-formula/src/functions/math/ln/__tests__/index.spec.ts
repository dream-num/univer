...
import { Ln } from '../index';

describe('Test ln function', () => {
    const testFunction = new Ln(FUNCTION_NAMES_MATH.LN);
    ...
    describe('Ln', () => {
        ...
        it('Value is number string', () => {
            ...
            const result = testFunction.calculate(value);
            expect(getObjectValue(result, true)).toBe(0.405465108108);
        });
        ...
        it('Value is array', () => {
            ...
            expect(getObjectValue(result, true)).toStrictEqual([
                [0, ErrorType.VALUE, 0.207014169384, 0, ErrorType.NUM, ErrorType.NUM],
                [ErrorType.NUM, 4.60517018599, 0.85015092937, ErrorType.VALUE, ErrorType.NUM, ErrorType.NAME],
            ]);
        });
    });
});
