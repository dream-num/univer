...
import { Log10 } from '../index';

describe('Test log10 function', () => {
    const testFunction = new Log10(FUNCTION_NAMES_MATH.LOG10);
    ...
    describe('Log10', () => {
        ...
        it('Value is array', () => {
            ...
            expect(getObjectValue(result, true)).toStrictEqual([
                [0, ErrorType.VALUE, 0.0899051114394, 0, ErrorType.NUM, ErrorType.NUM],
                [ErrorType.NUM, 2, 0.36921585741, ErrorType.VALUE, ErrorType.NUM, ErrorType.NAME],
            ]);
        });
    });
});
