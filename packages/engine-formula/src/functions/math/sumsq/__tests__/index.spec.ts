...
describe('Test sumsq function', () => {
    const testFunction = new Sumsq(FUNCTION_NAMES_MATH.SUMSQ);
    ...
    describe('Sumsq', () => {
        ...
        it('Var1 is number, var2 is array not includes error', () => {
            ...
            const result = testFunction.calculate(var1, var2);
            expect(stripErrorMargin(Number(result.getValue()))).toBe(10020.9885);
        });
    });
});
