...
describe('Test sumxmy2 function', () => {
    const testFunction = new Sumxmy2(FUNCTION_NAMES_MATH.SUMXMY2);
    ...
    describe('Sumxmy2', () => {
        ...
        it('arrayX.length === arrayY.length', () => {
            ...
            const result = testFunction.calculate(arrayX, arrayY);
            expect(stripErrorMargin(Number(result.getValue()))).toBe(8);
        });
    });
});
