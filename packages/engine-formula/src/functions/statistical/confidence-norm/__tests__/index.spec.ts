...
import { ConfidenceNorm } from '../index';

describe('Test confidenceNorm function', () => {
    const testFunction = new ConfidenceNorm(FUNCTION_NAMES_STATISTICAL.CONFIDENCE_NORM);

    describe('ConfidenceNorm', () => {
        it('Value is normal', () => {
