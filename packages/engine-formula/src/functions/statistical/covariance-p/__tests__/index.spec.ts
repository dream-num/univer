...
import { CovarianceP } from '../index';

describe('Test covarianceP function', () => {
    const testFunction = new CovarianceP(FUNCTION_NAMES_STATISTICAL.COVARIANCE_P);

    describe('CovarianceP', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result, true)).toBe(188.006666666667);
        });
