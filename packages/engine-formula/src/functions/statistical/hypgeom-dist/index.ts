...
export class HypgeomDist extends BaseFunction {
    ...
    override calculate(
        ...
        const resultArray = sampleSArray.mapValue((sampleSObject, rowIndex, columnIndex) => {
            ...
            return this._handleSingleObject(sampleSObject, numberSampleObject, populationSObject, numberPopObject, cumulativeObject);
        });
    ...
    private _handleSingleObject(
        ...
        const [_sampleSObject, _numberSampleObject, _populationSObject, _numberPopObject, _cumulativeObject] = variants as BaseValueObject[];
