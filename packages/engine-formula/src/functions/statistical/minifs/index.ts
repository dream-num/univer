...
export class Minifs extends BaseFunction {
    ...
    override calculate(minRange: FunctionVariantType, ...variants: FunctionVariantType[]): BaseValueObject {
        const {
            isError,
            errorObject,
            ...
            targetRange: _minRange,
            variants: _variants,
        } = parsePairedRangeAndCriteria(variants, minRange);
        ...
        return this._aggregateResults(_minRange as BaseValueObject, booleanResults);
    }

    private _aggregateResults(minRange: BaseValueObject, booleanResults: BaseValueObject[][]): BaseValueObject {
