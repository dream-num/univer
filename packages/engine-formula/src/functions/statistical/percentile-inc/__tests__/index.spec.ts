...
describe('Test percentileInc function', () => {
    const testFunction = new PercentileInc(FUNCTION_NAMES_STATISTICAL.PERCENTILE_INC);
    ...
    describe('PercentileInc', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result, true)).toBe(3.7);
        });
