...
import { PercentrankInc } from '../index';

describe('Test percentrankInc function', () => {
    const testFunction = new PercentrankInc(FUNCTION_NAMES_STATISTICAL.PERCENTRANK_INC);

    describe('PercentrankInc', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result)).toStrictEqual(0.255);
        });
        ...
        it('Significance value test', () => {
            ...
            const result = testFunction.calculate(array, x, significance);
            expect(getObjectValue(result)).toStrictEqual(0.4581111111);
