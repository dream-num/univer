...
import { Permutationa } from '../index';

describe('Test permutationa function', () => {
    const testFunction = new Permutationa(FUNCTION_NAMES_STATISTICAL.PERMUTATIONA);
    ...
    describe('Permutationa', () => {
        it('Value is normal number', () => {
            ...
            expect(getObjectValue(result)).toBe(64);
        });
