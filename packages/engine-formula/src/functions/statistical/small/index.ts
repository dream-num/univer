...
import { getArrayValuesByAggregateIgnoreOptions, getSmallResult } from '../../../basics/statistical';
import { checkVariantsErrorIsStringToNumber } from '../../../engine/utils/check-variant-error';
import { BaseFunction } from '../../base-function';

export class Small extends BaseFunction {
    ...
    private _handleSingleObject(array: number[] | ErrorValueObject, k: BaseValueObject): BaseValueObject {
        ...
        return getSmallResult(array, kValue);
    }
}
