...
import { TDistRt } from '../index';

describe('Test tDistRt function', () => {
    const testFunction = new TDistRt(FUNCTION_NAMES_STATISTICAL.T_DIST_RT);
    ...
    describe('TDistRt', () => {
        ...
        it('Value is array', () => {
            ...
            expect(getObjectValue(result)).toStrictEqual([
                ...
                [0.4999999999999998, 0.00004999250124970711, 0.07207975447577919, ErrorType.VALUE, 0.9522670168666455, ErrorType.NAME],
            ]);
        });
    });
});
