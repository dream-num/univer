...
describe('Test formula data model', () => {
    describe('formulaDataModel function', () => {
        ...
        describe('updateNumfmtData', () => {
            it('update numfmt data', () => {
                const unitId = 'test';
                const sheetId = 'sheet1';

                formulaDataModel.setNumfmtItemMap({
                    [unitId]: {
                        [sheetId]: {
                            0: {
                                3: '0.00',
                ...
                formulaDataModel.updateNumfmtData(unitId, sheetId, cellValue);

                const numfmtData = formulaDataModel.getNumfmtItemMap();
                expect(numfmtData).toStrictEqual(result);
            });
        });

        describe('updateNumfmtMap', () => {
            it('update numfmt map data', () => {
                const unitId = 'test';
                const sheetId = 'sheet1';
                ...
                formulaDataModel.updateNumfmtItemMap(numfmtItemMap);
