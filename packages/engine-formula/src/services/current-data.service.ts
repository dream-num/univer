            ...
            for (const sheetId in rowData[unitId]) {
                ...
                if (this._unitData[unitId][sheetId] == null) {
                    this._unitData[unitId][sheetId] = {
                        ...
                        columnCount: 0,
                        rowData: {},
                        columnManager: this._univerInstanceService.getUnit<Workbook>(unitId)?.getSheetBySheetId(sheetId)?.getColumnManager() || (() => { throw new Error('ColumnManager is undefined'); })(),
                    };
                }
