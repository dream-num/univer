...
const locale: typeof enUS = {
    'find-replace': {
        ...
        mobile: {
            settings: 'إعدادات البحث والاستبدال',
            'settings-title': 'إعدادات البحث والاستبدال',
            'previous-match': 'التطابق السابق',
            'next-match': 'التطابق التالي',
            close: 'إغلاق البحث والاستبدال',
        },
        shortcut: {
