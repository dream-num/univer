...
export const FUNCTION_LIST_FINANCIAL: IFunctionInfo[] = [
    ...
    },
    {
        ...
        functionParameter: [
            {
                name: 'formula.functionList.AMORDEGRC.functionParameter.cost.name',
                detail: 'formula.functionList.AMORDEGRC.functionParameter.cost.detail',
                example: '2400',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.AMORDEGRC.functionParameter.datePurchased.name',
                detail: 'formula.functionList.AMORDEGRC.functionParameter.datePurchased.detail',
                example: '"2008-8-19"',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.AMORDEGRC.functionParameter.firstPeriod.name',
                detail: 'formula.functionList.AMORDEGRC.functionParameter.firstPeriod.detail',
                example: '"2008-12-31"',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.AMORDEGRC.functionParameter.salvage.name',
                detail: 'formula.functionList.AMORDEGRC.functionParameter.salvage.detail',
                example: '300',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.AMORDEGRC.functionParameter.period.name',
                detail: 'formula.functionList.AMORDEGRC.functionParameter.period.detail',
                example: '1',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.AMORDEGRC.functionParameter.rate.name',
                detail: 'formula.functionList.AMORDEGRC.functionParameter.rate.detail',
                example: '15%',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.AMORDEGRC.functionParameter.basis.name',
                detail: 'formula.functionList.AMORDEGRC.functionParameter.basis.detail',
                example: '1',
                require: 0,
                repeat: 0,
            },
