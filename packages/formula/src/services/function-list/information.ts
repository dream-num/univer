...
export const FUNCTION_LIST_INFORMATION: IFunctionInfo[] = [
    ...
    },
    {
        ...
        functionParameter: [
            {
                name: 'formula.functionList.INFO.functionParameter.typeText.name',
                detail: 'formula.functionList.INFO.functionParameter.typeText.detail',
                example: '"system"',
                require: 1,
                repeat: 0,
            },
    ...
    },
    {
        ...
        functionParameter: [
            {
                name: 'formula.functionList.ISOMITTED.functionParameter.argument.name',
                detail: 'formula.functionList.ISOMITTED.functionParameter.argument.detail',
                example: 'value',
                require: 1,
                repeat: 0,
            },
