...
export const FUNCTION_LIST_LOOKUP: IFunctionInfo[] = [
    ...
    },
    {
        ...
        functionParameter: [
            {
                name: 'formula.functionList.GETPIVOTDATA.functionParameter.dataField.name',
                detail: 'formula.functionList.GETPIVOTDATA.functionParameter.dataField.detail',
                example: '"Sales"',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.GETPIVOTDATA.functionParameter.pivotTable.name',
                detail: 'formula.functionList.GETPIVOTDATA.functionParameter.pivotTable.detail',
                example: 'A3',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.GETPIVOTDATA.functionParameter.field1.name',
                detail: 'formula.functionList.GETPIVOTDATA.functionParameter.field1.detail',
                example: '"Month"',
                require: 0,
                repeat: 1,
            },
            {
                name: 'formula.functionList.GETPIVOTDATA.functionParameter.item1.name',
                detail: 'formula.functionList.GETPIVOTDATA.functionParameter.item1.detail',
                example: '"March"',
                require: 0,
                repeat: 1,
            },
    ...
    },
    {
        ...
        functionParameter: [
            {
                name: 'formula.functionList.RTD.functionParameter.progId.name',
                detail: 'formula.functionList.RTD.functionParameter.progId.detail',
                example: '"mycomaddin.progid"',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.RTD.functionParameter.server.name',
                detail: 'formula.functionList.RTD.functionParameter.server.detail',
                example: '""',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.RTD.functionParameter.topic1.name',
                detail: 'formula.functionList.RTD.functionParameter.topic1.detail',
                example: '"Topic"',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.RTD.functionParameter.topic2.name',
                detail: 'formula.functionList.RTD.functionParameter.topic2.detail',
                example: '"Item"',
                require: 0,
                repeat: 1,
            },
