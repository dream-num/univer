    ...
    return (
        <div className={styles.cfRuleStyleEditor}>
            ...
            <div className={`${styleBase.mTBase}`}>
                <RangeSelector placeholder={localeService.t('sheet.cf.form.rangeSelector')} width={'100%' as unknown as number} openForSheetSubUnitId={subUnitId} openForSheetUnitId={unitId} value={rangeString} id={`${SHEET_CONDITION_FORMAT_PLUGIN}_rangeSelector`} onChange={onRangeSelectorChange} />
            </div>
