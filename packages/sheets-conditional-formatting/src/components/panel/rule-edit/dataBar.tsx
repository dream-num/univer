...
import { CFRuleType, CFValueType, createDefaultValueByValueType, SHEET_CONDITIONAL_FORMATTING_PLUGIN } from '../../../base/const';
import type { IConditionalFormattingRuleConfig, IValueConfig } from '../../../models/type';
