...
import { CFNumberOperator,
    CFRuleType,
    CFSubRuleType,
    CFTextOperator,
    CFTimePeriodOperator,
    createDefaultValue } from '../../../base/const';
import type {
...
const HighlightCellInput = (props: { type: IResult['subType'] | CFSubRuleType.duplicateValues | CFSubRuleType.uniqueValues;
