    ...
    'sheets-data-validation': {
        ...
        date: {
            ...
            errorMsg: {
                ...
                notBetween: 'El valor debe ser una fecha legal y no estar entre {FORMULA1} y {FORMULA2}',
        ...
        textLength: {
            errorMsg: {
                ...
                notBetween: 'La longitud del texto no debe estar entre {FORMULA1} y {FORMULA2}',
            },
