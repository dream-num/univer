...
export class UniverSheetsDrawingMobileUIPlugin extends Plugin {
    ...
    override onStarting(): void {
        ...
        registerDependencies(this._injector, mergeOverrideWithDependencies(dependencies, this._config.overrides));
    ...
    override onSteady(): void {
        this._injector.get(MobileDrawingPopupMenuController);
