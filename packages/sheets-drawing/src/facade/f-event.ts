 ...
 * @ignore
 */
interface IFSheetsDrawingEventNameMixin {
    /**
     ...
     * @see {@link IBeforeOverGridImageInsertEventParams}
     * @example
     * ```ts
     ...
     * @see {@link IOverGridImageInsertedEventParams}
     * @example
     * ```ts
     ...
     * @see {@link IBeforeOverGridImageRemoveEventParams}
     * @example
     * ```ts
     ...
     * @see {@link IOverGridImageRemovedEventParams}
     * @example
     * ```ts
     ...
     * @see {@link IBeforeOverGridImageChangeEventParams}
     * @example
     * ```ts
     ...
     * @see {@link IOverGridImageChangedEventParams}
     * @example
     * ```ts
     ...
     * @see {@link IBeforeOverGridImageSelectEventParams}
     * @example
     * ```ts
     ...
     * @see {@link IOverGridImageSelectedEventParams}
     * @example
     * ```ts
...
export class FSheetsDrawingEventNameMixin extends FEventName implements IFSheetsDrawingEventNameMixin {
...
export interface IBeforeOverGridImageChangeEventParams extends IEventBase {
    /**
...
export interface IOverGridImageChangedEventParams extends IEventBase {
    /**
     * The workbook instance currently being operated on. {@link FWorkbook}
     */
    workbook: FWorkbook;
...
export interface IBeforeOverGridImageInsertEventParams extends IEventBase {
    /**
     * The workbook instance currently being operated on. {@link FWorkbook}
     */
    workbook: FWorkbook;
...
export interface IOverGridImageInsertedEventParams extends IEventBase {
    /**
     * The workbook instance currently being operated on. {@link FWorkbook}
     */
    workbook: FWorkbook;
...
export interface IBeforeOverGridImageRemoveEventParams extends IEventBase {
    /**
     * The workbook instance currently being operated on. {@link FWorkbook}
     */
    workbook: FWorkbook;
...
export interface IOverGridImageRemovedEventParams extends IEventBase {
    /**
     * The workbook instance currently being operated on. {@link FWorkbook}
     */
    workbook: FWorkbook;
...
export interface IBeforeOverGridImageSelectEventParams extends IEventBase {
    /**
     * The workbook instance currently being operated on. {@link FWorkbook}
     */
    workbook: FWorkbook;
...
export interface IOverGridImageSelectedEventParams extends IEventBase {
    /**
     * The workbook instance currently being operated on. {@link FWorkbook}
     */
    workbook: FWorkbook;
...
interface ISheetsDrawingEventParamConfig {
    BeforeOverGridImageChange: IBeforeOverGridImageChangeEventParams;
    OverGridImageChanged: IOverGridImageChangedEventParams;

    BeforeOverGridImageInsert: IBeforeOverGridImageInsertEventParams;
    OverGridImageInserted: IOverGridImageInsertedEventParams;

    BeforeOverGridImageRemove: IBeforeOverGridImageRemoveEventParams;
    OverGridImageRemoved: IOverGridImageRemovedEventParams;

    BeforeOverGridImageSelect: IBeforeOverGridImageSelectEventParams;
    OverGridImageSelected: IOverGridImageSelectedEventParams;
}

FEventName.extend(FSheetsDrawingEventNameMixin);
declare module '@univerjs/core/facade' {
    // eslint-disable-next-line ts/naming-convention
    interface FEventName extends IFSheetsDrawingEventNameMixin { }
    interface IEventParamConfig extends ISheetsDrawingEventParamConfig { }
}
