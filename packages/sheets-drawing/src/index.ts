...
export { deriveSheetGroupRotateEnabled, deriveSheetGroupRotateEnabledFromChildren, isKnownSheetNonRotatableDrawingType, resolveSheetDrawingRotateEnabled, withDerivedSheetGroupRotateEnabled, withDerivedSheetGroupRotateEnabledFromChildren } from './common/rotate-enabled';
