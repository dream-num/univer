...
import { SheetsFindReplaceMobileController } from './controllers/mobile/sheet-find-replace-mobile.controller';
...
export class UniverSheetsFindReplaceMobileUIPlugin extends Plugin {
