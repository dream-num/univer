...
export default {
    DATE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/date-function-e36c0c8c-4104-49da-ab83-82328b832349',
            },
        ],
        functionParameter: {
    ...
    DATEDIF: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/datedif-function-25dba1a4-2812-480b-84dd-8b32a451b35c',
            },
        ],
        functionParameter: {
    ...
    DATEVALUE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/datevalue-function-df8b07d4-7761-4a93-bc33-b7471bbff252',
            },
        ],
        functionParameter: {
    ...
    DAY: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/day-function-8a7d1cbb-6c7d-4ba1-8aea-25c134d03101',
            },
        ],
        functionParameter: {
    ...
    DAYS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/days-function-57740535-d549-4395-8728-0f07bff0b9df',
            },
        ],
        functionParameter: {
    ...
    DAYS360: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/days360-function-b9a509fd-49ef-407e-94df-0cbda5718c2a',
            },
        ],
        functionParameter: {
            startDate: { name: 'start_date', detail: 'Start_date and End_date are the two dates between which you want to know the number of days.' },
    ...
    EDATE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/edate-function-3c920eb2-6e66-44e7-a1f5-753ae47ee4f5',
            },
        ],
        functionParameter: {
    ...
    EOMONTH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/eomonth-function-7314ffa1-2bc9-4005-9d66-f49db127d628',
            },
        ],
        functionParameter: {
    ...
    HOUR: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/hour-function-a3afa879-86cb-4339-b1b5-2dd2d7310ac7',
            },
        ],
        functionParameter: {
            serialNumber: { name: 'serial_number', detail: 'The date of the day you are trying to find. Dates should be entered by using the DATE function, or as results of other formulas or functions. For example, use DATE(2008,5,23) for the 23rd day of May, 2008.' },
    ...
    ISOWEEKNUM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/isoweeknum-function-1c2d0afe-d25b-4ab1-8894-8d0520e90e0e',
            },
        ],
        functionParameter: {
    ...
    MINUTE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/minute-function-af728df0-05c4-4b07-9eed-a84801a60589',
            },
        ],
        functionParameter: {
            serialNumber: { name: 'serial_number', detail: 'The date of the day you are trying to find. Dates should be entered by using the DATE function, or as results of other formulas or functions. For example, use DATE(2008,5,23) for the 23rd day of May, 2008.' },
    ...
    MONTH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/month-function-579a2881-199b-48b2-ab90-ddba0eba86e8',
            },
        ],
        functionParameter: {
    ...
    NETWORKDAYS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/networkdays-function-48e717bf-a7a3-495f-969e-5005e3eb18e7',
            },
        ],
        functionParameter: {
    ...
    NETWORKDAYS_INTL: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/networkdays-intl-function-a9b26239-4f20-46a1-9ab8-4e925bfd5e28',
            },
        ],
        functionParameter: {
            startDate: { name: 'start_date', detail: 'A date that represents the start date.' },
    ...
    NOW: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/now-function-3337fd29-145a-4347-b2e6-20c904739c46',
            },
        ],
        functionParameter: {
        },
    ...
    SECOND: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/second-function-740d1cfc-553c-4099-b668-80eaa24e8af1',
            },
        ],
        functionParameter: {
            serialNumber: { name: 'serial_number', detail: 'The date of the day you are trying to find. Dates should be entered by using the DATE function, or as results of other formulas or functions. For example, use DATE(2008,5,23) for the 23rd day of May, 2008.' },
    ...
    TIME: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/time-function-9a5aff99-8f7d-4611-845e-747d0b8d5457',
            },
        ],
        functionParameter: {
    ...
    TIMEVALUE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/timevalue-function-0b615c12-33d8-4431-bf3d-f3eb6d186645',
            },
        ],
        functionParameter: {
    ...
    TODAY: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/today-function-5eb3078d-a82c-4736-8930-2f51a028fdd9',
            },
        ],
        functionParameter: {
        },
    ...
    WEEKDAY: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/weekday-function-60e44483-2ed1-439f-8bd0-e404c190949a',
            },
        ],
        functionParameter: {
    ...
    WEEKNUM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/weeknum-function-e5c43a03-b4ab-426c-b411-b18c13c75340',
            },
        ],
        functionParameter: {
    ...
    WORKDAY: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/workday-function-f764a5b7-05fc-4494-9486-60d494efbf33',
            },
        ],
        functionParameter: {
            startDate: { name: 'start_date', detail: 'A date that represents the start date.' },
    ...
    WORKDAY_INTL: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/workday-intl-function-a378391c-9ba7-4678-8a39-39611a9bf81d',
            },
        ],
        functionParameter: {
            startDate: { name: 'start_date', detail: 'A date that represents the start date.' },
    ...
    YEAR: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/year-function-c64f017a-1354-490d-981f-578e8ec8d3b9',
            },
        ],
        functionParameter: {
    ...
    YEARFRAC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/yearfrac-function-3844141e-c76d-4143-82b6-208454ddc6a8',
            },
        ],
        functionParameter: {
            startDate: { name: 'start_date', detail: 'A date that represents the start date.' },
