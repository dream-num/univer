...
export class PromptController extends Disposable {
    ...
    private _initSelectionsEndListener() {
        ...
        this.disposeWithMe(this._refSelectionsService.selectionMoveEnd$.subscribe((selections) => {
            ...
            // theme color should be set when selection coltrol is created, it's too late to set theme color at selecitonEnd(pointerup).
    ...
    /**
     * user can use cursor to select a range on the canvas and move the selection with keyboard shortcuts
     */
     ...
     *
     * This function is invoked when create a seleciton(pointer down at spreadsheet) & update selection(drag move at spreadsheet)
     *
     * refSelectionsRenderService@_pointerDown --> refSelectionsRenderService@_selectionMoveStart$ --> _syncToEditor
     * refSelectionsRenderService@_moving --> refSelectionsRenderService@_selectionMoving$ --> _insertControlSelections --> _insertControlSelectionReplace --> _syncToEditor
     * @param sequenceNodes
    ...
    private _syncToEditor(
        ...
        // if create a new ref selection, get theme color from prompt formula editor.
        this._allSelectionRenderServices.forEach((r) => this._updateRefSelectionStyle(r, this._isSelectionMovingRefSelections));
