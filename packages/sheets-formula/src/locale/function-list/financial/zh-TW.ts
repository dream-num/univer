...
export default {
    ...
    INTRATE: {
        ...
        links: [
            {
                title: '教導',
                url: 'https://support.microsoft.com/zh-cn/office/intrate-%E5%87%BD%E6%95%B0-5cb34dde-a221-4cb6-b​​3eb-0b9e55e1316f',
            },
        ],
        functionParameter: {
            number1: { name: 'number1', detail: 'first' },
    ...
    ODDFYIELD: {
        ...
        links: [
            {
                title: '教導', url: 'https://support.microsoft.com/zh-cn/office/oddfyield-%E5%87%BD%E6%95%B0-66bc8b7b-6501-4c93-9ce3-2fd16220fe37',
            },
        ],
        functionParameter: {
            number1: { name: 'number1', detail: 'first' },
