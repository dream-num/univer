...
export default {
    CELL: {
        ...
        functionParameter: {
            info_type: {
                name: 'info_type',
                detail: '要返回的单元格信息的类型。可以是"address"、"col"、"color"等。',
            },
            reference: {
                name: 'reference',
                detail: '要检查的单元格。可以是单个单元格引用或单元格范围。',
            },
        },
    },
    ERROR_TYPE: {
        ...
        functionParameter: {
            error_val: {
                name: 'error_val',
                detail: '要查找错误类型的错误值。可以是单个单元格引用或错误值。',
            },
        },
    },
    INFO: {
        ...
        functionParameter: {
            type_text: {
                name: 'type_text',
                detail: '要返回的信息类型。可以是"directory"、"numfile"、"origin"等。',
            },
        },
    },
    ISBLANK: {
        ...
        functionParameter: {
            value: {
                name: '值',
                detail: '指的是要测试的值。 参数 value 可以是空白（空单元格）、错误值、逻辑值、文本、数字、引用值，或者引用要测试的以上任意值的名称。',
            },
        },
    },
    ISERR: {
    ...
    ISEVEN: {
        ...
        functionParameter: {
            value: {
                name: '值',
                detail: '要测试的值。如果 number 不是整数，将被截尾取整。',
            },
        },
    },
    ISFORMULA: {
