...
export const FUNCTION_LIST_LOGICAL: IFunctionInfo[] = [
    ...
    },
    {
        ...
        functionParameter: [
            ...
            {
                name: 'formula.functionList.SWITCH.functionParameter.value.name',
                detail: 'formula.functionList.SWITCH.functionParameter.value.detail',
                example: '1',
                require: 1,
                repeat: 1,
            },
            {
                name: 'formula.functionList.SWITCH.functionParameter.result.name',
                detail: 'formula.functionList.SWITCH.functionParameter.result.detail',
                example: '"Sunday"',
                require: 1,
                repeat: 0,
            },
            {
                name: 'formula.functionList.SWITCH.functionParameter.default.name',
                detail: 'formula.functionList.SWITCH.functionParameter.default.detail',
                example: '"No match"',
                require: 1,
                repeat: 0,
            },
