import { SheetAction, ActionObservers, ISheetActionData, Workbook } from '@univer/core';
...
export class AddImagePropertyAction extends SheetAction<IAddImageProperty, IAddImageProperty> {
