...
describe('SheetsSortUIController', () => {
    ...
    beforeEach(() => {
        ...
        const testBed = createCommandTestBed(undefined, [
            ...
            [IMenuManagerService, { useValue: { mergeMenu: vi.fn() } as unknown as IMenuManagerService }],
            [IDialogService, { useValue: { open: vi.fn(() => createDisposable()), close: vi.fn() } as unknown as IDialogService }],
            [ILayoutService, { useValue: { focus: vi.fn() } as unknown as ILayoutService }],
            [IUIPartsService, { useValue: { registerComponent: vi.fn(() => createDisposable()) } as unknown as IUIPartsService }],
            [SheetsRenderService, { useValue: { registerSkeletonChangingMutations: vi.fn(() => createDisposable()) } as unknown as SheetsRenderService }],
            [ComponentManager, { useValue: { register: vi.fn(() => createDisposable()) } as unknown as ComponentManager }],
        ]);
