...
import { MobileCustomSortPanel } from '../../views/mobile/MobileCustomSortPanel';

export const MOBILE_CUSTOM_SORT_PANEL = 'MobileCustomSortPanel';
...
export class MobileComponentsController extends Disposable {
    constructor(
        ...
        this.disposeWithMe(componentManager.register(MOBILE_CUSTOM_SORT_PANEL, MobileCustomSortPanel));
    }
}
