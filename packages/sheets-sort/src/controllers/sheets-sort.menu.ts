...
import { SortRangeAscCommand, SortRangeAscInCtxMenuCommand, SortRangeCustomCommand, SortRangeCustomInCtxMenuCommand, SortRangeDescCommand, SortRangeDescInCtxMenuCommand } from '../commands/sheets-reorder.command';
...
// export function sheetsSortCtxMenuFactory(accessor: IAccessor): IMenuItem {
//     return {
//         id: SHEETS_SORT_CTX_MENU_ID,
//         type: MenuItemType.SUBITEMS,
//         positions: [MenuPosition.TOOLBAR_START],
