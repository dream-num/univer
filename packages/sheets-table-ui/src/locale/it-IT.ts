...
const locale: typeof enUS = {
    'sheets-table-ui': {
        ...
        filter: {
            ...
            back: 'Indietro',
            resize: 'Ridimensiona',
            'filter-by-cell-fill-color': 'Colore di riempimento cella',
            'filter-by-cell-text-color': 'Colore testo cella',
            'filter-by-color-none': 'Questa colonna contiene un solo colore',
