...
const locale: typeof enUS = {
    'sheets-table-ui': {
        ...
        filter: {
            ...
            'filter-by-cell-fill-color': 'Kolor wypełnienia komórki',
            'filter-by-cell-text-color': 'Kolor tekstu komórki',
            'filter-by-color-none': 'Ta kolumna zawiera tylko jeden kolor',
