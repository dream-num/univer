...
describe('spreadsheet headers and cell document helpers', () => {
    ...
    beforeEach(() => {
        ...
        const modelSkeleton = new SpreadsheetSkeleton(workbook.getActiveSheet()!).calculate();
        skeleton = injector.createInstance(SpreadsheetRenderSkeleton, modelSkeleton, workbook.getStyles()).calculate();
