...
import { createSheetGapTestConfig, SheetRenderSkeletonBase } from '../sheet-render-skeleton.base';
...
class TestableSheetSkeleton extends SheetRenderSkeletonBase {
...
describe('SheetRenderSkeletonBase integration', () => {
    ...
    it('should calculate merged layout coordinates and offsets from a worksheet snapshot', () => {
        ...
        const skeleton = new SheetRenderSkeletonBase(
