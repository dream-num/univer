...
import { Text, VERTICAL_ROTATE_ANGLE } from '@univerjs/engine-render';
...
function createSpreadsheetRenderSkeleton() {
...
describe('font extension', () => {
    ...
    it('covers clip bounds for overflow/offset align branches', () => {
        ...
        const skeleton = createSpreadsheetRenderSkeleton();
    ...
    it('covers documents render branches and missing documents error', () => {
        ...
        const ctx = createCtx();
        const overflow = new ObjectMatrix<any>();
        const spreadsheetSkeleton = createSpreadsheetRenderSkeleton();
    ...
    it('covers draw and render-each-cell early/normal branches', () => {
        ...
        const hiddenSkeleton = createSpreadsheetRenderSkeleton();
