...
import { type IViewportInfo, RENDER_CLASS_TYPE, RenderComponent, type UniverRenderingContext, type Vector2 } from '@univerjs/engine-render';

export abstract class SheetComponent extends RenderComponent<SpreadsheetRenderSkeleton, SHEET_EXTENSION_TYPE, IRange[]> {
    constructor(
        oKey: string,
    ...
    updateSkeleton(spreadsheetSkeleton: SpreadsheetRenderSkeleton) {
