...
import {
    ...
    type IDocumentSkeletonColumn,
    type IPoint,
    type ITransformChangeState,
    type IViewportInfo,
    MAXIMUM_COL_WIDTH,
    MAXIMUM_ROW_HEIGHT,
    MIN_COL_WIDTH,
...
import { SheetRenderSkeletonBase } from './sheet-render-skeleton.base';
...
export class SpreadsheetRenderSkeleton extends SheetRenderSkeletonBase {
    /**
    ...
    constructor(
        ...
        super(spreadsheetSkeleton, _styles, _localeService, _contextService, _configService, _injector);
        this._updateLayout();
        this.disposeWithMe(
    ...
    /**
     * Returns the style repository used by this render skeleton.
     */
    getStyles(): Styles {
        return this._styles;
    }
    ...
    setStylesCache(vpInfo?: IViewportInfo): Nullable<SpreadsheetRenderSkeleton> {
