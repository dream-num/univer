...
function scanSparseExtensionFeatures(spreadsheetSkeleton: SpreadsheetRenderSkeleton, ranges: IRange[]): ISparseExtensionFeatureFlags | null {
...
export class Spreadsheet extends SheetComponent {
    ...
    renderByViewports(mainCtx: UniverRenderingContext2D, viewportInfo: IViewportInfo, spreadsheetSkeleton: SpreadsheetRenderSkeleton) {
