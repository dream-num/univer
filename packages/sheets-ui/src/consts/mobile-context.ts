...
/** Whether the mobile formula function panel is open above the formula editor. */
export const MOBILE_FORMULA_FUNCTION_PANEL_OPEN = 'MOBILE_FORMULA_FUNCTION_PANEL_OPEN';
