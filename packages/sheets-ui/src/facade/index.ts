...
interface IFUniverSheetUIMixin {
    /**
...
export class FUniverSheetUIMixin extends FUniver implements IFUniverSheetUIMixin {
...
declare module '@univerjs/core' {
    ...
    interface FUniver extends IFUniverSheetUIMixin { }
}
