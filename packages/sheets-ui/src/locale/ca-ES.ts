...
const locale: typeof enUS = {
    'sheets-ui': {
        ...
        mobile: {
            ...
            operation: 'Accions',
            style: 'Estil',
            openTools: 'Obre les eines del full',
            closeTools: 'Tanca les eines del full',
            addSheet: 'Afegeix un full',
            sheetMenu: 'Obre el menú del full',
            ...
            confirm: 'Confirmar',
            customFormatDescription: 'Genera formats de nombre personalitzats basats en els existents.',
        },
        sheetConfig: {
        ...
        info: {
            ...
            overwriteCellContent: 'Ja hi ha dades a l\'àrea de destinació. Aquesta acció sobreescriurà les dades existents. Voleu continuar?',
        },
        clipboard: {
            paste: {
