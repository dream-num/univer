...
const locale: typeof enUS = {
    'sheets-ui': {
        ...
        mobile: {
            ...
            operation: 'Acciones',
            style: 'Estilo',
            openTools: 'Abrir herramientas de hoja',
            closeTools: 'Cerrar herramientas de hoja',
            addSheet: 'Añadir hoja',
            sheetMenu: 'Abrir menú de hoja',
            ...
            confirm: 'Confirmar',
            customFormatDescription: 'Generar formatos de número personalizados basados en los existentes.',
        },
        sheetConfig: {
