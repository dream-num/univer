...
const locale: typeof enUS = {
    'sheets-ui': {
        ...
        mobile: {
            ...
            operation: 'عملیات',
            style: 'سبک',
            openTools: 'باز کردن ابزارهای برگه',
            closeTools: 'بستن ابزارهای برگه',
            addSheet: 'افزودن برگه',
            sheetMenu: 'باز کردن منوی برگه',
            borderColor: 'رنگ حاشیه',
            borderStyle: 'سبک حاشیه',
            recentColors: 'رنگ‌های اخیر',
            customColor: 'رنگ سفارشی',
            applyColor: 'اعمال رنگ',
            back: 'بازگشت',
            formula: 'فرمول',
            collapseEditor: 'جمع کردن ویرایشگر',
            confirm: 'تایید',
            customFormatDescription: 'ایجاد قالب‌بندی‌های عددی سفارشی بر اساس قالب‌بندی‌های موجود.',
        },
        sheetConfig: {
        ...
        permission: {
            ...
            dialog: {
                ...
                cutErr: 'محدوده محافظت شده است و شما مجوز برش را ندارید. برای برش، لطفا با سازنده تماس بگیرید.',
