...
const locale: typeof enUS = {
    'sheets-ui': {
        ...
        mobile: {
            ...
            operation: 'Actions',
            style: 'Style',
            openTools: 'Ouvrir les outils de la feuille',
            closeTools: 'Fermer les outils de la feuille',
            addSheet: 'Ajouter une feuille',
            sheetMenu: 'Ouvrir le menu de la feuille',
            ...
            confirm: 'Confirmer',
            customFormatDescription: 'Générer des formats de nombre personnalisés basés sur des formats existants.',
        },
        sheetConfig: {
        ...
        info: {
            ...
            overwriteCellContent: 'Il y a déjà des données dans la zone cible. Cette action écrasera les données existantes. Voulez-vous continuer ?',
        },
        clipboard: {
            paste: {
