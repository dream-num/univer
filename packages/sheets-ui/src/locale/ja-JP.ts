...
const locale: typeof enUS = {
    'sheets-ui': {
        ...
        mobile: {
            ...
            style: 'スタイル',
            openTools: 'シートツールを開く',
            closeTools: 'シートツールを閉じる',
            addSheet: 'シートを追加',
            sheetMenu: 'シートメニューを開く',
            borderColor: '罫線の色',
            borderStyle: '罫線のスタイル',
            ...
            confirm: '確認',
            customFormatDescription: '既存の表示形式を基にユーザー定義の数値表示形式を作成します。',
        },
        sheetConfig: {
            sheetTabs: 'シートタブ',
        ...
        info: {
            ...
            overwriteCellContent: '対象範囲には既にデータが存在します。この操作により既存のデータが上書きされます。続行しますか?',
        },
        clipboard: {
            paste: {
