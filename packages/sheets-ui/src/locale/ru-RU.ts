...
const locale: typeof enUS = {
    'sheets-ui': {
        ...
        mobile: {
            ...
            operation: 'Действия',
            style: 'Стиль',
            openTools: 'Открыть инструменты листа',
            closeTools: 'Закрыть инструменты листа',
            addSheet: 'Добавить лист',
            sheetMenu: 'Открыть меню листа',
            ...
            confirm: 'Подтвердить',
            customFormatDescription: 'Генерация пользовательских числовых форматов на основе существующих форматов.',
        },
        sheetConfig: {
        ...
        info: {
            ...
            overwriteCellContent: 'В целевой области уже есть данные, это действие перезапишет их. Продолжить?',
        },
        clipboard: {
            paste: {
