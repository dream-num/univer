...
const locale: typeof enUS = {
    'sheets-ui': {
        ...
        mobile: {
            ...
            operation: 'Thao tác',
            style: 'Kiểu',
            openTools: 'Mở công cụ trang tính',
            closeTools: 'Đóng công cụ trang tính',
            addSheet: 'Thêm trang tính',
            sheetMenu: 'Mở menu trang tính',
            ...
            confirm: 'Xác nhận',
            customFormatDescription: 'Tạo định dạng số tùy chỉnh dựa trên các định dạng hiện có.',
        },
        sheetConfig: {
