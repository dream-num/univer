    ...
    describe('Copy cells of a worksheet with default styles', () => {
        it('worksheet has default style', async () => {
            ...
            const result = `<google data-copy-id="${copyId}"-sheets-html-origin><table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" style="table-layout:fixed;font-size:10pt;font-family:Arial;width:0px;border-collapse:collapse;border:none"><colgroup><col  width="88" /></colgroup>
                <tbody><tr style="height: 24px;"><td style="font-size: 20pt; color: rgb(255,0,0); border-bottom: 0.5pt solid rgb(0,0,0); border-top: 0.5pt solid rgb(0,0,0); border-right: 0.5pt solid rgb(0,0,0); border-left: 0.5pt solid rgb(0,0,0); ">1</td></tr><tr style="height: 24px;"><td style="font-size: 20pt; color: rgb(255,0,0); border-bottom: 0.5pt solid rgb(0,0,0); border-top: 0.5pt solid rgb(0,0,0); border-right: 0.5pt solid rgb(0,0,0); border-left: 0.5pt solid rgb(0,0,0); ">2</td></tr><tr style="height: 24px;"><td style="font-size: 20pt; color: rgb(255,0,0); border-bottom: 0.5pt solid rgb(0,0,0); border-top: 0.5pt solid rgb(0,0,0); border-right: 0.5pt solid rgb(0,0,0); border-left: 0.5pt solid rgb(0,0,0); ">3</td></tr><tr style="height: 24px;"><td style="font-size: 20pt; color: rgb(255,0,0); border-bottom: 0.5pt solid rgb(0,0,0); border-top: 0.5pt solid rgb(0,0,0); border-right: 0.5pt solid rgb(0,0,0); border-left: 0.5pt solid rgb(0,0,0); ">4</td></tr></tbody></table>`;
