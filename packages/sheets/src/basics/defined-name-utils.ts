...
export function validateDefinedName(name: string, options: IValidateDefinedNameOptions): true | string {
    if (name.length === 0) {
        return 'sheets-ui.definedName.nameEmpty';
    }
    ...
    if (
        ...
        return 'sheets-ui.definedName.nameDuplicate';
    }
    ...
    if (
        ...
        return 'sheets-ui.definedName.nameInvalid';
    }
