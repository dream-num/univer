        ...
        sheets: {
            sheet1: {
                ...
                cellData: {
                    39: {
                        5: {
                            f: '=IF(ISBLANK(E40)," - ",IF(G40=0,E40,E40+G40-1))',
                        },
                        8: {
                            f: '=IF(OR(F40=0,E40=0)," - ",NETWORKDAYS(E40,F40))',
                        },
                    },
                },
            },
...
describe('Test inverted index cache 6', () => {
    ...
    describe('Test formula', () => {
        it('Test blank cell compare number 0', () => {
            expect(getCellValue(39, 5)).toBe(' - ');
            expect(getCellValue(39, 8)).toBe(' - ');
        });
    });
});
