...
import { AUTO_HEIGHT_FOR_MERGED_CELLS, DependentOn, FLOAT_STATISTIC, IConfigService, Inject, Injector, IS_ROW_STYLE_PRECEDE_COLUMN_STYLE, merge, mergeOverrideWithDependencies, Plugin, registerDependencies, touchDependencies, UniverInstanceType } from '@univerjs/core';
...
export class UniverSheetsPlugin extends Plugin {
    ...
    private _initConfig(): void {
        ...
        if (this._config?.floatStatistic) {
            this._configService.setConfig(FLOAT_STATISTIC, true);
        }
    }
