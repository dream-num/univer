...
import { Dmax } from '../index';

describe('Test dmax function', () => {
    const testFunction = new Dmax(FUNCTION_NAMES_DATABASE.DMAX);
    ...
    describe('Dmax', () => {
        ...
        it('Criteria value test', () => {
            ...
            expect(getObjectValue(result4)).toStrictEqual(14);
        });
    });
});
