...
import { Dmin } from '../index';

describe('Test dmin function', () => {
    const testFunction = new Dmin(FUNCTION_NAMES_DATABASE.DMIN);
    ...
    describe('Dmin', () => {
        ...
        it('Criteria value test', () => {
            ...
            expect(getObjectValue(result4)).toStrictEqual(6);
        });
    });
});
