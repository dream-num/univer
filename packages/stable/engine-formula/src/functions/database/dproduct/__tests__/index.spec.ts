...
import { Dproduct } from '../index';

describe('Test dproduct function', () => {
    const testFunction = new Dproduct(FUNCTION_NAMES_DATABASE.DPRODUCT);
    ...
    describe('Dproduct', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result)).toStrictEqual(140);
        });
        ...
        it('Database value test', () => {
            ...
            expect(getObjectValue(result2)).toStrictEqual(10);
            ...
            expect(getObjectValue(result4)).toStrictEqual(10);
        });
        ...
        it('Criteria value test', () => {
            ...
            const result = testFunction.calculate(database, field, criteria);
            expect(getObjectValue(result)).toStrictEqual(604800);
            ...
            expect(getObjectValue(result4)).toStrictEqual(604800);
        });
    });
});
