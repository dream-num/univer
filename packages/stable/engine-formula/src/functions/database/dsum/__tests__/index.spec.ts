...
import { Dsum } from '../index';

describe('Test dsum function', () => {
    const testFunction = new Dsum(FUNCTION_NAMES_DATABASE.DSUM);
    ...
    describe('Dsum', () => {
        ...
        it('Criteria value test', () => {
            ...
            const result = testFunction.calculate(database, field, criteria);
            expect(getObjectValue(result)).toStrictEqual(57);
            ...
            expect(getObjectValue(result4)).toStrictEqual(57);
        });
    });
});
