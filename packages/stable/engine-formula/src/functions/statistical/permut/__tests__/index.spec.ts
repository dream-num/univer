...
import { Permut } from '../index';

describe('Test permut function', () => {
    const testFunction = new Permut(FUNCTION_NAMES_STATISTICAL.PERMUT);
    ...
    describe('Permut', () => {
        it('Value is normal number', () => {
            ...
            expect(getObjectValue(result)).toBe(56);
        });
        ...
        it('Value is array', () => {
            ...
            expect(getObjectValue(result)).toStrictEqual([
                ...
                [ErrorType.NUM, 9900, 2, ErrorType.VALUE, ErrorType.NUM, ErrorType.NAME],
            ]);
        });
    });
});
