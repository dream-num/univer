...
import { QuartileInc } from '../index';

describe('Test quartileInc function', () => {
    const testFunction = new QuartileInc(FUNCTION_NAMES_STATISTICAL.QUARTILE_INC);

    describe('QuartileInc', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result)).toStrictEqual(3.25);
        });
        ...
        it('Quart value test', () => {
            ...
            expect(getObjectValue(result3)).toStrictEqual(3.25);
