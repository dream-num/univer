...
import { SkewP } from '../index';

describe('Test skewP function', () => {
    const testFunction = new SkewP(FUNCTION_NAMES_STATISTICAL.SKEW_P);
    ...
    describe('SkewP', () => {
        it('Value is normal', () => {
            ...
            expect(getObjectValue(result)).toStrictEqual(4.9343245538895844e-17);
        });
