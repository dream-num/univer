...
export default {
    ACCRINT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/accrint-function-fe45d089-6722-4fb3-9379-e1f911d8dc74',
            },
        ],
        functionParameter: {
    ...
    ACCRINTM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/accrintm-function-f62f01f9-5754-4cc4-805b-0e70199328a7',
            },
        ],
        functionParameter: {
            issue: { name: 'issue', detail: "The security's issue date." },
    ...
    AMORDEGRC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/amordegrc-function-a14d0ca1-64a4-42eb-9b3d-b0dededf9e51',
            },
        ],
        functionParameter: {
    ...
    AMORLINC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/amorlinc-function-7d417b45-f7f5-4dba-a0a5-3451a81079a8',
            },
        ],
        functionParameter: {
    ...
    COUPDAYBS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/coupdaybs-function-eb9a8dfb-2fb2-4c61-8e5d-690b320cf872',
            },
        ],
        functionParameter: {
    ...
    COUPDAYS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/coupdays-function-cc64380b-315b-4e7b-950c-b30b0a76f671',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    COUPDAYSNC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/coupdaysnc-function-5ab3f0b2-029f-4a8b-bb65-47d525eea547',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    COUPNCD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/coupncd-function-fd962fef-506b-4d9d-8590-16df5393691f',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    COUPNUM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/coupnum-function-a90af57b-de53-4969-9c99-dd6139db2522',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    COUPPCD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/couppcd-function-2eb50473-6ee9-4052-a206-77a9a385d5b3',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    CUMIPMT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/cumipmt-function-61067bb0-9016-427d-b95b-1a752af0e606',
            },
        ],
        functionParameter: {
    ...
    CUMPRINC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/cumprinc-function-94a4516d-bd65-41a1-bc16-053a6af4c04d',
            },
        ],
        functionParameter: {
            rate: { name: 'rate', detail: 'The interest rate.' },
    ...
    DB: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/db-function-354e7d28-5f93-4ff1-8a52-eb4ee549d9d7',
            },
        ],
        functionParameter: {
    ...
    DDB: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ddb-function-519a7a37-8772-4c96-85c0-ed2c209717a5',
            },
        ],
        functionParameter: {
            cost: { name: 'cost', detail: 'The initial cost of the asset.' },
    ...
    DISC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/disc-function-71fce9f3-3f05-4acf-a5a3-eac6ef4daa53',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    DOLLARDE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/dollarde-function-db85aab0-1677-428a-9dfd-a38476693427',
            },
        ],
        functionParameter: {
    ...
    DOLLARFR: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/dollarfr-function-0835d163-3023-4a33-9824-3042c5d4f495',
            },
        ],
        functionParameter: {
    ...
    DURATION: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/duration-function-b254ea57-eadc-4602-a86a-c8e369334038',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    EFFECT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/effect-function-910d4e4c-79e2-4009-95e6-507e04f11bc4',
            },
        ],
        functionParameter: {
    ...
    FV: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/fv-function-2eef9f44-a084-4c61-bdd8-4fe4bb1b71b3',
            },
        ],
        functionParameter: {
    ...
    FVSCHEDULE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/fvschedule-function-bec29522-bd87-4082-bab9-a241f3fb251d',
            },
        ],
        functionParameter: {
    ...
    INTRATE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/intrate-function-5cb34dde-a221-4cb6-b3eb-0b9e55e1316f',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    IPMT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ipmt-function-5cce0ad6-8402-4a41-8d29-61a0b054cb6f',
            },
        ],
        functionParameter: {
            rate: { name: 'rate', detail: 'The interest rate per period.' },
    ...
    IRR: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/irr-function-64925eaa-9988-495b-b290-3ad0c163c1bc',
            },
        ],
        functionParameter: {
    ...
    ISPMT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ispmt-function-fa58adb6-9d39-4ce0-8f43-75399cea56cc',
            },
        ],
        functionParameter: {
    ...
    MDURATION: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/mduration-function-b3786a69-4f20-469a-94ad-33e5b90a763c',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    MIRR: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/mirr-function-b020f038-7492-4fb4-93c1-35c345b53524',
            },
        ],
        functionParameter: {
    ...
    NOMINAL: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/nominal-function-7f1ae29b-6b92-435e-b950-ad8b190ddd2b',
            },
        ],
        functionParameter: {
    ...
    NPER: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/nper-function-240535b5-6653-4d2d-bfcf-b6a38151d815',
            },
        ],
        functionParameter: {
            rate: { name: 'rate', detail: 'The interest rate per period.' },
    ...
    NPV: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/npv-function-8672cb67-2576-4d07-b67b-ac28acf2a568',
            },
        ],
        functionParameter: {
    ...
    ODDFPRICE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/oddfprice-function-d7d664a8-34df-4233-8d2b-922bcf6a69e1',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    ODDFYIELD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/oddfyield-function-66bc8b7b-6501-4c93-9ce3-2fd16220fe37',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    ODDLPRICE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/oddlprice-function-fb657749-d200-4902-afaf-ed5445027fc4',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    ODDLYIELD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/oddlyield-function-c873d088-cf40-435f-8d41-c8232fee9238',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    PDURATION: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/pduration-function-44f33460-5be5-4c90-b857-22308892adaf',
            },
        ],
        functionParameter: {
    ...
    PMT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/pmt-function-0214da64-9a63-4996-bc20-214433fa6441',
            },
        ],
        functionParameter: {
            rate: { name: 'rate', detail: 'The interest rate per period.' },
    ...
    PPMT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ppmt-function-c370d9e3-7749-4ca4-beea-b06c6ac95e1b',
            },
        ],
        functionParameter: {
            rate: { name: 'rate', detail: 'The interest rate per period.' },
    ...
    PRICE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/price-function-3ea9deac-8dfa-436f-a7c8-17ea02c21b0a',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    PRICEDISC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/pricedisc-function-d06ad7c1-380e-4be7-9fd9-75e3079acfd3',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    PRICEMAT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/pricemat-function-52c3b4da-bc7e-476a-989f-a95f675cae77',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    PV: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/pv-function-23879d31-0e02-4321-be01-da16e8168cbd',
            },
        ],
        functionParameter: {
            rate: { name: 'rate', detail: 'The interest rate per period.' },
    ...
    RATE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/rate-function-9f665657-4a7e-4bb7-a030-83fc59e748ce',
            },
        ],
        functionParameter: {
            nper: { name: 'nper', detail: 'The total number of payment periods in an annuity.' },
    ...
    RECEIVED: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/received-function-7a3f8b93-6611-4f81-8576-828312c9b5e5',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    RRI: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/rri-function-6f5822d8-7ef1-4233-944c-79e8172930f4',
            },
        ],
        functionParameter: {
    ...
    SLN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sln-function-cdb666e5-c1c6-40a7-806a-e695edc2f1c8',
            },
        ],
        functionParameter: {
            cost: { name: 'cost', detail: 'The initial cost of the asset.' },
    ...
    SYD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/syd-function-069f8106-b60b-4ca2-98e0-2a0f206bdb27',
            },
        ],
        functionParameter: {
            cost: { name: 'cost', detail: 'The initial cost of the asset.' },
    ...
    TBILLEQ: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/tbilleq-function-2ab72d90-9b4d-4efe-9fc2-0f81f2c19c8c',
            },
        ],
        functionParameter: {
    ...
    TBILLPRICE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/tbillprice-function-eacca992-c29d-425a-9eb8-0513fe6035a2',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The Treasury bill's settlement date." },
    ...
    TBILLYIELD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/tbillyield-function-6d381232-f4b0-4cd5-8e97-45b9c03468ba',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The Treasury bill's settlement date." },
    ...
    VDB: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/vdb-function-dde4e207-f3fa-488d-91d2-66d55e861d73',
            },
        ],
        functionParameter: {
            cost: { name: 'cost', detail: 'The initial cost of the asset.' },
    ...
    XIRR: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/xirr-function-de1242ec-6477-445b-b11b-a303ad9adc9d',
            },
        ],
        functionParameter: {
    ...
    XNPV: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/xnpv-function-1b42bbf6-370f-4532-a0eb-d67c16b664b7',
            },
        ],
        functionParameter: {
    ...
    YIELD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/yield-function-f5f5ca43-c4bd-434f-8bd2-ed3c9727a4fe',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    YIELDDISC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/yielddisc-function-a9dbdbae-7dae-46de-b995-615faffaaed7',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
    ...
    YIELDMAT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/yieldmat-function-ba7d1809-0d33-4bcb-96c7-6c56ec62ef6f',
            },
        ],
        functionParameter: {
            settlement: { name: 'settlement', detail: "The security's settlement date." },
