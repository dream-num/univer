...
export default {
    ABS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/abs-function-3420200f-5628-4e8c-99da-c99d7c87713c',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The real number of which you want the absolute value.' },
        },
    },
    ACOS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/acos-function-cb73173f-d089-4582-afa1-76e5524b5d5b',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The cosine of the angle you want and must be from -1 to 1.' },
        },
    },
    ACOSH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/acosh-function-e3992cc1-103f-4e72-9f04-624b9ef5ebfe',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number equal to or greater than 1.' },
        },
    },
    ACOT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/acot-function-dc7e5008-fe6b-402e-bdd6-2eea8383d905',
            },
        ],
        functionParameter: {
            number: {
    ...
    ACOTH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/acoth-function-cc49480f-f684-4171-9fc5-73e4e852300f',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The absolute value of Number must be greater than 1.' },
        },
    },
    AGGREGATE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/aggregate-function-43b9278e-6aa7-4f17-92b6-e19993fa26df',
            },
        ],
        functionParameter: {
    ...
    ARABIC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/arabic-function-9a8da418-c17b-4ef9-a657-9370a30a674f',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'premier' },
    ...
    ASIN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/asin-function-81fb95e5-6d6f-48c4-bc45-58f955c6d347',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The sine of the angle you want and must be from -1 to 1.' },
        },
    },
    ASINH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/asinh-function-4e00475a-067a-43cf-926a-765b0249717c',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number.' },
        },
    },
    ATAN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/atan-function-50746fa8-630a-406b-81d0-4a2aed395543',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The tangent of the angle you want.' },
        },
    },
    ATAN2: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/atan2-function-c04592ab-b9e3-4908-b428-c96b3a565033',
            },
        ],
        functionParameter: {
    ...
    ATANH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/atanh-function-3cd65768-0de7-4f1d-b312-d01c8c930d90',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number between 1 and -1.' },
        },
    },
    BASE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/base-function-2ef61411-aee9-4f29-a811-1c42456c6342',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number that you want to convert. Must be an integer greater than or equal to 0 and less than 2^53.' },
    ...
    CEILING: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ceiling-function-0a5cd7c8-0720-4f0a-bd2c-c943e510899f',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value you want to round.' },
    ...
    CEILING_MATH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ceiling-math-function-80f95d2f-b499-4eee-9f16-f795a8e306c8',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value you want to round.' },
    ...
    CEILING_PRECISE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ceiling-precise-function-f366a774-527a-4c92-ba49-af0a196e66cb',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value you want to round.' },
    ...
    COMBIN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/combin-function-12a3f276-0a21-423a-8de6-06990aaf638a',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number of items.' },
            numberChosen: { name: 'nombre_chosen', detail: 'The number of items in each combination.' },
        },
    },
    COMBINA: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/combina-function-efb49eaa-4f4c-4cd2-8179-0ddfcf9d035d',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number of items.' },
    ...
    COS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/cos-function-0fb808a5-95d6-4553-8148-22aebdce5f05',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The angle in radians for which you want the cosine.' },
        },
    },
    COSH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/cosh-function-e460d426-c471-43e8-9540-a57ff3b70555',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number for which you want to find the hyperbolic cosine.' },
        },
    },
    COT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/cot-function-c446f34d-6fe4-40dc-84f8-cf59e5f5e31a',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The angle in radians for which you want the cotangent.' },
        },
    },
    COTH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/coth-function-2e0b4cb6-0ba0-403e-aed4-deaa71b49df5',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number for which you want to find the hyperbolic cotangent.' },
        },
    },
    CSC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/csc-function-07379361-219a-4398-8675-07ddc4f135c1',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The angle in radians for which you want the cosecant.' },
        },
    },
    CSCH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/csch-function-f58f2c22-eb75-4dd6-84f4-a503527f8eeb',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The angle in radians for which you want the hyperbolic cosecant.' },
        },
    },
    DECIMAL: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/decimal-function-ee554665-6176-46ef-82de-0a283658da2e',
            },
        ],
        functionParameter: {
    ...
    DEGREES: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/degrees-function-4d6ec4db-e694-4b94-ace0-1cc3f61f9ba1',
            },
        ],
        functionParameter: {
    ...
    EVEN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/even-function-197b5f06-c795-4c1e-8696-3c3b8a646cf9',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value to round.' },
        },
    },
    EXP: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/exp-function-c578f034-2c45-4c37-bc8c-329660a63abe',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The exponent applied to the base e.' },
        },
    },
    FACT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/fact-function-ca8588c2-15f2-41c0-8e8c-c11bd471a4f3',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The nonnegative number for which you want the factorial. If number is not an integer, it is truncated.' },
        },
    },
    FACTDOUBLE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/factdouble-function-e67697ac-d214-48eb-b7b7-cce2589ecac8',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The nonnegative number for which you want the double factorial. If number is not an integer, it is truncated.' },
        },
    },
    FLOOR: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/floor-function-14bb497c-24f2-4e04-b327-b0b4de5a8886',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value you want to round.' },
    ...
    FLOOR_MATH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/floor-math-function-c302b599-fbdb-4177-ba19-2c2b1249a2f5',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value you want to round.' },
    ...
    FLOOR_PRECISE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/floor-precise-function-f769b468-1452-4617-8dc3-02f842a0702e',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value you want to round.' },
    ...
    GCD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/gcd-function-d5107a51-69e3-461f-8e4c-ddfc21b5073a',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'To find the first number of the greatest common divisor, you can also use a single array or a reference to an array instead of the comma-separated parameters.' },
            number2: { name: 'nombre2', detail: 'The second number whose greatest common divisor is to be found. Up to 255 numbers can be specified in this way.' },
        },
    },
    INT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/int-function-a6c4af9e-356d-4369-ab6a-cb1fd9d343ef',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The real number you want to round down to an integer.' },
        },
    },
    ISO_CEILING: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/iso-ceiling-function-e587bb73-6cc2-4113-b664-ff5b09859a83',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'premier' },
    ...
    LCM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/lcm-function-7152b67a-8bb5-4075-ae5c-06ede5563c94',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'To find the first number of the least common multiple, you can also use a single array or a reference to an array instead of the comma-separated parameters.' },
            number2: { name: 'nombre2', detail: 'The second number whose least common multiple is to be found. Up to 255 numbers can be specified in this way.' },
        },
    },
    LET: {
    ...
    LN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/ln-function-81fe1ed7-dac9-4acd-ba1d-07a142c6118f',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The positive real number for which you want the natural logarithm.' },
        },
    },
    LOG: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/log-function-4e82f196-1ca9-4747-8fb0-6c4a3abb3280',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The positive real number for which you want the logarithm.' },
    ...
    LOG10: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/log10-function-c75b881b-49dd-44fb-b6f4-37e3486a0211',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The positive real number for which you want the base-10 logarithm.' },
        },
    },
    MDETERM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/mdeterm-function-e7bfa857-3834-422b-b871-0ffd03717020',
            },
        ],
        functionParameter: {
    ...
    MINVERSE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/minverse-function-11f55086-adde-4c9f-8eb9-59da2d72efc6',
            },
        ],
        functionParameter: {
            array: { name: 'array', detail: 'A numeric array with an equal number of rows and columns.' },
    ...
    MMULT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/mmult-function-40593ed7-a3cd-4b6b-b9a3-e4ad3c7245eb',
            },
        ],
        functionParameter: {
    ...
    MOD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/mod-function-9b6cd169-b6ee-406a-a97b-edf2a9dc24f3',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number for which you want to find the remainder.' },
    ...
    MROUND: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/mround-function-c299c3b0-15a5-426d-aa4b-d2d5b3baf427',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value to round.' },
    ...
    MULTINOMIAL: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/multinomial-function-6fa6373c-6533-41a2-a45e-a56db1db1bf6',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'The first value or range to use in the calculation.' },
            number2: { name: 'nombre2', detail: 'Additional values ​​or ranges to use in calculations.' },
        },
    },
    MUNIT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/munit-function-c9fe916a-dc26-4105-997d-ba22799853a3',
            },
        ],
        functionParameter: {
    ...
    ODD: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/odd-function-deae64eb-e08a-4c88-8b40-6d0b42575c98',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The value to round.' },
    ...
    PI: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/pi-function-264199d0-a3ba-46b8-975a-c4a04608989b',
            },
        ],
        functionParameter: {
        },
    ...
    POWER: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/power-function-d3f2908b-56f4-4c3f-895a-07fb519c362a',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The base number. It can be any real number.' },
    ...
    PRODUCT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/product-function-8e6b5b24-90ee-4650-aeec-80982a0512ce',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'The first number or range that you want to multiply.' },
            number2: { name: 'nombre2', detail: 'Additional numbers or ranges that you want to multiply, up to a maximum of 255 arguments.' },
        },
    },
    QUOTIENT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/quotient-function-9f7bf099-2a18-4282-8fa4-65290cc99dee',
            },
        ],
        functionParameter: {
    ...
    RADIANS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/radians-function-ac409508-3d48-45f5-ac02-1497c92de5bf',
            },
        ],
        functionParameter: {
    ...
    RAND: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/rand-function-4cbfa695-8869-4788-8d90-021ea9f5be73',
            },
        ],
        functionParameter: {
        },
    ...
    RANDARRAY: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/randarray-function-21261e55-3bec-4885-86a6-8b0a47fd4d33',
            },
        ],
        functionParameter: {
    ...
    RANDBETWEEN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/randbetween-function-4cc7f0d1-87dc-4eb7-987f-a469ab381685',
            },
        ],
        functionParameter: {
    ...
    ROMAN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/roman-function-d6b0b99e-de46-4704-a518-b45a0f8b56f5',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'premier' },
    ...
    ROUND: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/round-function-c018c5d8-40fb-4053-90b1-b3e7f61a213c',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number that you want to round.' },
    ...
    ROUNDDOWN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/rounddown-function-2ec94c73-241f-4b01-8c6f-17e6d7968f53',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number that you want to round.' },
    ...
    ROUNDUP: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/roundup-function-f8bc9b23-e795-47db-8703-db171d0c42a7',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number that you want to round.' },
    ...
    SEC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sec-function-ff224717-9c87-4170-9b58-d069ced6d5f7',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Number is the angle in radians for which you want the secant.' },
        },
    },
    SECH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sech-function-e05a789f-5ff7-4d7f-984a-5edb9b09556f',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Number is the angle in radians for which you want the hyperbolic secant.' },
        },
    },
    SERIESSUM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/seriessum-function-a3ab25b5-1093-4f5b-b084-96c49087f637',
            },
        ],
        functionParameter: {
    ...
    SEQUENCE: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sequence-function-57467a98-57e0-4817-9f14-2eb78519ca90',
            },
        ],
        functionParameter: {
    ...
    SIGN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sign-function-109c932d-fcdc-4023-91f1-2dd0e916a1d8',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number.' },
    ...
    SIN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sin-function-cf0e3432-8b9e-483c-bc55-a76651c95602',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The angle in radians for which you want the sine.' },
        },
    },
    SINH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sinh-function-1e4e8b9f-2b65-43fc-ab8a-0a37f4081fa7',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number.' },
    ...
    SQRT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sqrt-function-654975c2-05c4-4831-9a24-2c65e4040fdf',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number for which you want the square root.' },
        },
    },
    SQRTPI: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sqrtpi-function-1fb4e63f-9b51-46d6-ad68-b3e7a8b519b4',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number by which pi is multiplied.' },
        },
    },
    SUBTOTAL: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/subtotal-function-7b027003-f060-4ade-9040-e478765b9939',
            },
        ],
        functionParameter: {
    ...
    SUM: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sum-function-043e1c7d-7726-4e80-8f32-07b23e057f89',
            },
        ],
        functionParameter: {
            number1: {
    ...
    SUMIF: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sumif-function-169b8c99-c05c-4483-a712-1697a653039b',
            },
        ],
        functionParameter: {
            range: {
    ...
    SUMIFS: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sumifs-function-c9e748f5-7ea7-455d-9406-611cebce642b',
            },
        ],
        functionParameter: {
    ...
    SUMPRODUCT: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sumproduct-function-16753e75-9f68-4874-94ac-4d2145a2fd2e',
            },
        ],
        functionParameter: {
    ...
    SUMSQ: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sumsq-function-e3313c02-51cc-4963-aae6-31442d9ec307',
            },
        ],
        functionParameter: {
            number1: { name: 'nombre1', detail: 'To square and find the first number, you can also use a single array or a reference to an array instead of comma-separated parameters.' },
            number2: { name: 'nombre2', detail: 'The second number to be squared and summed. Up to 255 numbers can be specified in this way.' },
        },
    },
    SUMX2MY2: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sumx2my2-function-9e599cc5-5399-48e9-a5e0-e37812dfa3e9',
            },
        ],
        functionParameter: {
    ...
    SUMX2PY2: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sumx2py2-function-826b60b4-0aa2-4e5e-81d2-be704d3d786f',
            },
        ],
        functionParameter: {
            arrayX: { name: 'array_x', detail: 'The first array or range of values.' },
    ...
    SUMXMY2: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/sumxmy2-function-9d144ac1-4d79-43de-b524-e2ecee23b299',
            },
        ],
        functionParameter: {
            arrayX: { name: 'array_x', detail: 'The first array or range of values.' },
    ...
    TAN: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/tan-function-08851a40-179f-4052-b789-d7f699447401',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The angle in radians for which you want the tangent.' },
        },
    },
    TANH: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/tanh-function-017222f0-a0c3-4f69-9787-b3202295dc6c',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'Any real number.' },
    ...
    TRUNC: {
        ...
        links: [
            {
                title: 'Instruction',
                url: 'https://support.microsoft.com/fr-fr/office/trunc-function-8b86a64c-3127-43db-ba14-aa5ceb292721',
            },
        ],
        functionParameter: {
            number: { name: 'nombre', detail: 'The number you want to truncate.' },
