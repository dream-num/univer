...
import { createContext, forwardRef, use, useEffect, useImperativeHandle, useMemo, useRef, useState } from 'react';
...
export function DropdownWrapper(props: Omit<Partial<IDropdownProps>, 'overlay'> & { overlay: ReactNode; align?: 'start' | 'end' | 'center' }) {
    ...
    const { setDropdownVisible } = use(TooltipWrapperContext);
