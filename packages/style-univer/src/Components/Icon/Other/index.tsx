...
const Close = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} name="logo" style={props.style}>
        <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4224" width="1em" height="1em" fill="currentColor">
...
const DropDownIcon = (props: BaseIconProps) => (
    <Icon spin={props.spin} rotate={props.rotate} name="dropdown" style={props.style}>
        <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4519" width="1em" height="1em">
...
export class UniverClose implements IconComponent {
