...
import { Context, Nullable, Observer, Workbook1, Worksheet1 } from '@univer/core';
...
export class CellRangeModal extends Component<BaseCellRangeModalProps, CellModalState> {
    ...
    private _localeObserver1: Nullable<Observer<Worksheet1>>;
    ...
    componentDidMount() {
        ...
        this._localeObserver1 = this._context
            .getObserverManager()
            .getObserver<Worksheet1>('onAfterSetSelectionObservable', 'worksheet')
            ?.add((text) => {
                console.dir(text);
            });
    }
