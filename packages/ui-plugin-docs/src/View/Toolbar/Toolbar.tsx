...
export class Toolbar extends Component<IProps, IState> {
    ...
    resetUl = () => {
        const wrapper = this.getContext().getPluginManager().getPluginByName<DocUIPlugin>(DOC_UI_PLUGIN_NAME)?.getAppUIController().getDocContainerController().getContentRef()
            .current!;
